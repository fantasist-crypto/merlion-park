...
export interface IQueryClient {
   ...
   */
  cosmosAccount(
    input: QueryCosmosAccountRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryCosmosAccountRequest, QueryCosmosAccountResponse>
  /**
   ...
   */
  validatorAccount(
    input: QueryValidatorAccountRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryValidatorAccountRequest, QueryValidatorAccountResponse>
  /**
  ...
  balance(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryBalanceRequest, QueryBalanceResponse>
  /**
   ...
   */
  storage(
    input: QueryStorageRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryStorageRequest, QueryStorageResponse>
  /**
  ...
  code(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryCodeRequest, QueryCodeResponse>
  /**
   ...
   */
  ethCall(
    input: EthCallRequest,
    options?: RpcOptions,
  ): UnaryCall<EthCallRequest, MsgEthereumTxResponse>
  /**
  ...
  estimateGas(
    input: EthCallRequest,
    options?: RpcOptions,
  ): UnaryCall<EthCallRequest, EstimateGasResponse>
  /**
   ...
   */
  traceTx(
    input: QueryTraceTxRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryTraceTxRequest, QueryTraceTxResponse>
  /**
   ...
   */
  traceBlock(
    input: QueryTraceBlockRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryTraceBlockRequest, QueryTraceBlockResponse>
}
/**
 * Query defines the gRPC querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  balance(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryBalanceRequest, QueryBalanceResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  storage(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryStorageRequest, QueryStorageResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  code(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryCodeRequest, QueryCodeResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  ethCall(
    ...
    const method = this.methods[7],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<EthCallRequest, MsgEthereumTxResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  estimateGas(
    ...
    const method = this.methods[8],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<EthCallRequest, EstimateGasResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  traceTx(
    ...
    const method = this.methods[9],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryTraceTxRequest, QueryTraceTxResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  traceBlock(
    ...
    const method = this.methods[10],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryTraceBlockRequest, QueryTraceBlockResponse>(
      'unary',
      this._transport,
      method,
      opt,
