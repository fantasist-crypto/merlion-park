 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.Params
 */
 ...
 * instead of *big.Int.
 *
 * @generated from protobuf messages ethermint.evm.v1.ChainConfig
 */
 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.State
 */
 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.TransactionLogs
 */
 ...
 * Consensus fields:
 *
 * @generated from protobuf messages ethermint.evm.v1.Log
 */
 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.TxResult
 */
 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.AccessTuple
 */
 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.TraceConfig
 */
...
class Params$Type extends MessageType<Params> {
    ...
    super('ethermint.evm.v1.Params', [
      {
        ...
        options: { 'gogoproto.moretags': 'yaml:"evm_denom"' },
      },
      {
        no: 2,
        name: 'enable_create',
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.moretags': 'yaml:"enable_create"' },
      },
      {
        no: 3,
        name: 'enable_call',
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.moretags': 'yaml:"enable_call"' },
      },
      {
        no: 4,
        name: 'extra_eips',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated int64 extra_eips */ 4:
          ...
          else message.extraEips.push(reader.int64().toString())
          break
        case /* ethermint.evm.v1.ChainConfig chain_config */ 5:
          message.chainConfig = ChainConfig.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.chainConfig,
  ...
  internalBinaryWrite(
    ...
    if (message.chainConfig)
      ChainConfig.internalBinaryWrite(
        message.chainConfig,
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.Params
 */
  ...
  internalBinaryWrite(
    ...
    if (message.constantinopleBlock !== '')
      writer
        ...
        .string(message.constantinopleBlock)
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.ChainConfig
 */
...
class State$Type extends MessageType<State> {
  ...
  create(value?: PartialMessage<State>): State {
    ...
    if (value !== undefined) reflectionMergePartial<State>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.State
 */
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.TransactionLogs
 */
  ...
  constructor() {
    super('ethermint.evm.v1.Log', [
      ...
      { no: 3, name: 'data', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
      {
        ...
        options: { 'gogoproto.jsontag': 'blockNumber' },
      },
      {
        no: 5,
        name: 'tx_hash',
        kind: 'scalar',
        T: 9 /*ScalarType.STRING*/,
        options: { 'gogoproto.jsontag': 'transactionHash' },
      },
      {
        no: 6,
        name: 'tx_index',
        kind: 'scalar',
        T: 4 /*ScalarType.UINT64*/,
        options: { 'gogoproto.jsontag': 'transactionIndex' },
      },
      {
        no: 7,
        name: 'block_hash',
        kind: 'scalar',
        T: 9 /*ScalarType.STRING*/,
        options: { 'gogoproto.jsontag': 'blockHash' },
      },
      {
        no: 8,
        name: 'index',
        kind: 'scalar',
        T: 4 /*ScalarType.UINT64*/,
        options: { 'gogoproto.jsontag': 'logIndex' },
      },
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.Log
 */
...
class TxResult$Type extends MessageType<TxResult> {
      ...
      [
        {
          ...
          kind: 'scalar',
          T: 9 /*ScalarType.STRING*/,
          options: { 'gogoproto.moretags': 'yaml:"contract_address"' },
        },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ethermint.evm.v1.TransactionLogs tx_logs */ 3:
          message.txLogs = TransactionLogs.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.txLogs,
  ...
  internalBinaryWrite(
    ...
    if (message.txLogs)
      TransactionLogs.internalBinaryWrite(
        message.txLogs,
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.TxResult
 */
    ...
    super(
      ...
      [
        { no: 1, name: 'address', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
        {
          ...
          repeat: 2 /*RepeatType.UNPACKED*/,
          T: 9 /*ScalarType.STRING*/,
          options: { 'gogoproto.jsontag': 'storageKeys' },
        },
      ],
      { 'gogoproto.goproto_getters': false },
    )
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.AccessTuple
 */
...
class TraceConfig$Type extends MessageType<TraceConfig> {
  constructor() {
    super('ethermint.evm.v1.TraceConfig', [
      ...
      { no: 3, name: 'reexec', kind: 'scalar', T: 4 /*ScalarType.UINT64*/ },
      {
        ...
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.jsontag': 'disableStack' },
      },
      {
        no: 6,
        ...
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.jsontag': 'disableStorage' },
      },
      ...
      { no: 10, name: 'overrides', kind: 'message', T: () => ChainConfig },
      {
        ...
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.jsontag': 'enableMemory' },
      },
      {
        no: 12,
        ...
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.jsontag': 'enableReturnData' },
      },
    ])
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ethermint.evm.v1.ChainConfig overrides */ 10:
          message.overrides = ChainConfig.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.overrides,
  ...
  internalBinaryWrite(
    ...
    /* int32 limit = 9; */
    if (message.limit !== 0) writer.tag(9, WireType.Varint).int32(message.limit)
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.TraceConfig
 */
