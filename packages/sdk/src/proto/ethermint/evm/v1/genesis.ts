 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.GenesisState
 */
 ...
 *
 * @generated from protobuf messages ethermint.evm.v1.GenesisAccount
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
      ...
      switch (fieldNo) {
        case /* repeated ethermint.evm.v1.GenesisAccount accounts */ 1:
          message.accounts.push(
            GenesisAccount.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.accounts.length; i++)
      GenesisAccount.internalBinaryWrite(
        message.accounts[i],
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.GenesisState
 */
      ...
      switch (fieldNo) {
        ...
        case /* repeated ethermint.evm.v1.State storage */ 3:
          message.storage.push(
            State.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
          let u = options.readUnknownField
...
/**
 * @generated MessageType for protobuf messages ethermint.evm.v1.GenesisAccount
 */
