...
// @generated from protobuf file "ethermint/crypto/v1/ethsecp256k1/keys.proto" (package "ethermint.crypto.v1.ethsecp256k1", syntax proto3)
// tslint:disable
 ...
 * key format.
 *
 * @generated from protobuf message ethermint.crypto.v1.ethsecp256k1.PubKey
 */
 ...
 *
 * @generated from protobuf message ethermint.crypto.v1.ethsecp256k1.PrivKey
 */
...
class PubKey$Type extends MessageType<PubKey> {
    constructor() {
        super("ethermint.crypto.v1.ethsecp256k1.PubKey", [
...
/**
 * @generated MessageType for protobuf message ethermint.crypto.v1.ethsecp256k1.PubKey
 */
export const PubKey = new PubKey$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PrivKey$Type extends MessageType<PrivKey> {
    constructor() {
        super("ethermint.crypto.v1.ethsecp256k1.PrivKey", [
            { no: 1, name: "key", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ethermint.crypto.v1.ethsecp256k1.PrivKey
 */
