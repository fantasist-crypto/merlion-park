 ...
 *
 * @generated from protobuf messages cosmos.params.v1beta1.QueryParamsRequest
 */
 ...
 *
 * @generated from protobuf messages cosmos.params.v1beta1.QueryParamsResponse
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.params.v1beta1.QueryParamsRequest
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.params.v1beta1.ParamChange param */ 1:
          message.param = ParamChange.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.param,
...
/**
 * @generated MessageType for protobuf messages cosmos.params.v1beta1.QueryParamsResponse
 */
...
export const Query = new ServiceType('cosmos.params.v1beta1.Query', [
  {
    name: 'Params',
    options: { 'google.api.http': { get: '/cosmos/params/v1beta1/params' } },
