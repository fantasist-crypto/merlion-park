 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.Tx
 */
export interface Tx {
  /**
 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.TxRaw
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.SignDoc
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.TxBody
 */
 ...
 * transaction.
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.AuthInfo
 */
 ...
 * signer.
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.SignerInfo
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.ModeInfo
 */
...
/**
 * Single is the mode info for a single signer. It is structured as a messages
 * to allow for additional fields such as locale for SIGN_MODE_TEXTUAL in the
 * future
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.ModeInfo.Single
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.ModeInfo.Multi
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.v1beta1.Fee
 */
...
class Tx$Type extends MessageType<Tx> {
  ...
  create(value?: PartialMessage<Tx>): Tx {
    ...
    if (value !== undefined) reflectionMergePartial<Tx>(this, message, value)
    return message
  }
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.tx.v1beta1.TxBody body */ 1:
          message.body = TxBody.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.body,
        ...
        case /* cosmos.tx.v1beta1.AuthInfo auth_info */ 2:
          message.authInfo = AuthInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.authInfo,
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.Tx
 */
...
class TxRaw$Type extends MessageType<TxRaw> {
  ...
  create(value?: PartialMessage<TxRaw>): TxRaw {
    ...
    if (value !== undefined) reflectionMergePartial<TxRaw>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.TxRaw
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.SignDoc
 */
...
class TxBody$Type extends MessageType<TxBody> {
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.extensionOptions.length; i++)
      Any.internalBinaryWrite(
        message.extensionOptions[i],
        writer.tag(1023, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* repeated google.protobuf.Any non_critical_extension_options = 2047; */
    for (let i = 0; i < message.nonCriticalExtensionOptions.length; i++)
      Any.internalBinaryWrite(
        message.nonCriticalExtensionOptions[i],
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.TxBody
 */
...
class AuthInfo$Type extends MessageType<AuthInfo> {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.tx.v1beta1.SignerInfo signer_infos */ 1:
          message.signerInfos.push(
            SignerInfo.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        case /* cosmos.tx.v1beta1.Fee fee */ 2:
          message.fee = Fee.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.fee,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.signerInfos.length; i++)
      SignerInfo.internalBinaryWrite(
        message.signerInfos[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* cosmos.tx.v1beta1.Fee fee = 2; */
    if (message.fee)
      Fee.internalBinaryWrite(
        message.fee,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.AuthInfo
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* cosmos.tx.v1beta1.ModeInfo mode_info */ 2:
          message.modeInfo = ModeInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.modeInfo,
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.SignerInfo
 */
...
class ModeInfo$Type extends MessageType<ModeInfo> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.tx.v1beta1.ModeInfo.Single single */ 1:
          message.sum = {
            oneofKind: 'single',
            single: ModeInfo_Single.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.sum as any).single,
            ),
          }
          break
        case /* cosmos.tx.v1beta1.ModeInfo.Multi multi */ 2:
          message.sum = {
            oneofKind: 'multi',
            multi: ModeInfo_Multi.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.sum as any).multi,
            ),
          }
          break
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.sum.oneofKind === 'single')
      ModeInfo_Single.internalBinaryWrite(
        message.sum.single,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
    ...
    if (message.sum.oneofKind === 'multi')
      ModeInfo_Multi.internalBinaryWrite(
        message.sum.multi,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.ModeInfo
 */
...
class ModeInfo_Single$Type extends MessageType<ModeInfo_Single> {
    ...
    super('cosmos.tx.v1beta1.ModeInfo.Single', [
      {
        ...
        name: 'mode',
        kind: 'enum',
        T: () => ['cosmos.tx.signing.v1beta1.SignMode', SignMode, 'SIGN_MODE_'],
      },
    ])
  }
  ...
  internalBinaryWrite(
    ...
    if (message.mode !== 0) writer.tag(1, WireType.Varint).int32(message.mode)
    let u = options.writeUnknownFields
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.ModeInfo.Single
 */
...
class ModeInfo_Multi$Type extends MessageType<ModeInfo_Multi> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.crypto.multisig.v1beta1.CompactBitArray bitarray */ 1:
          message.bitarray = CompactBitArray.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.bitarray,
        ...
        case /* repeated cosmos.tx.v1beta1.ModeInfo mode_infos */ 2:
          message.modeInfos.push(
            ModeInfo.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
          let u = options.readUnknownField
  ...
  internalBinaryWrite(
    ...
    if (message.bitarray)
      CompactBitArray.internalBinaryWrite(
        message.bitarray,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.ModeInfo.Multi
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.v1beta1.Fee
 */
