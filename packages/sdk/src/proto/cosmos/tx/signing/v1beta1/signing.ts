 ...
 *
 * @generated from protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptors
 */
 ...
 * clients.
 *
 * @generated from protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor.Data
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single
 */
 ...
 *
 * @generated from protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi
 */
...
class SignatureDescriptors$Type extends MessageType<SignatureDescriptors> {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.tx.signing.v1beta1.SignatureDescriptor signatures */ 1:
          message.signatures.push(
            SignatureDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.signatures.length; i++)
      SignatureDescriptor.internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptors
 */
...
class SignatureDescriptor$Type extends MessageType<SignatureDescriptor> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* cosmos.tx.signing.v1beta1.SignatureDescriptor.Data data */ 2:
          message.data = SignatureDescriptor_Data.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.data,
  ...
  internalBinaryWrite(
    ...
    if (message.data)
      SignatureDescriptor_Data.internalBinaryWrite(
        message.data,
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor
 */
...
class SignatureDescriptor_Data$Type extends MessageType<SignatureDescriptor_Data> {
  ...
  create(
    value?: PartialMessage<SignatureDescriptor_Data>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SignatureDescriptor_Data,
  ): SignatureDescriptor_Data {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single single */ 1:
          message.sum = {
            oneofKind: 'single',
            single: SignatureDescriptor_Data_Single.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
        ...
        case /* cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi multi */ 2:
          message.sum = {
            oneofKind: 'multi',
            multi: SignatureDescriptor_Data_Multi.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
  ...
  internalBinaryWrite(
    ...
    if (message.sum.oneofKind === 'single')
      SignatureDescriptor_Data_Single.internalBinaryWrite(
        message.sum.single,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
    ...
    if (message.sum.oneofKind === 'multi')
      SignatureDescriptor_Data_Multi.internalBinaryWrite(
        message.sum.multi,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor.Data
 */
...
class SignatureDescriptor_Data_Single$Type extends MessageType<SignatureDescriptor_Data_Single> {
  ...
  create(
    value?: PartialMessage<SignatureDescriptor_Data_Single>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SignatureDescriptor_Data_Single>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SignatureDescriptor_Data_Single,
  ): SignatureDescriptor_Data_Single {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Single
 */
export const SignatureDescriptor_Data_Single =
  new SignatureDescriptor_Data_Single$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class SignatureDescriptor_Data_Multi$Type extends MessageType<SignatureDescriptor_Data_Multi> {
  ...
  create(
    value?: PartialMessage<SignatureDescriptor_Data_Multi>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SignatureDescriptor_Data_Multi>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SignatureDescriptor_Data_Multi,
  ): SignatureDescriptor_Data_Multi {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.tx.signing.v1beta1.SignatureDescriptor.Data signatures */ 2:
          message.signatures.push(
            SignatureDescriptor_Data.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
...
/**
 * @generated MessageType for protobuf messages cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.Multi
 */
export const SignatureDescriptor_Data_Multi =
  new SignatureDescriptor_Data_Multi$Type()
