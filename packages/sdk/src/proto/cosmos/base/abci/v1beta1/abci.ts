 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.TxResponse
 */
...
/**
 * ABCIMessageLog defines a structure containing an indexed tx ABCI messages log.
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.ABCIMessageLog
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.StringEvent
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.Attribute
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.GasInfo
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.Result
 */
export interface Result {
  /**
   * Data is any data returned from messages or handler execution. It MUST be
   * length prefixed in order to separate data from multiple messages executions.
   *
   * @generated from protobuf field: bytes data = 1;
   */
  data: Uint8Array
  /**
   * Log contains the log information from messages or handler execution.
   *
   * @generated from protobuf field: string log = 2;
   */
  log: string
  /**
   * Events contains a slice of Event objects that were emitted during messages
 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.SimulationResponse
 */
...
/**
 * MsgData defines the data returned in a Result object during messages
 * execution.
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.MsgData
 */
 ...
 * for each messages.
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.TxMsgData
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.abci.v1beta1.SearchTxsResult
 */
...
class TxResponse$Type extends MessageType<TxResponse> {
    ...
    super(
      ...
      [
        { no: 1, name: 'height', kind: 'scalar', T: 3 /*ScalarType.INT64*/ },
        {
          ...
          options: { 'gogoproto.customname': 'TxHash' },
        },
        {
          no: 3,
          name: 'codespace',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.abci.v1beta1.ABCIMessageLog logs */ 7:
          message.logs.push(
            ABCIMessageLog.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        case /* string info */ 8:
        ...
        case /* google.protobuf.Any tx */ 11:
          message.tx = Any.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.tx,
  ...
  internalBinaryWrite(
    ...
    /* uint32 code = 4; */
    if (message.code !== 0) writer.tag(4, WireType.Varint).uint32(message.code)
    /* string data = 5; */
    if (message.data !== '')
    ...
    for (let i = 0; i < message.logs.length; i++)
      ABCIMessageLog.internalBinaryWrite(
        message.logs[i],
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.TxResponse
 */
...
class ABCIMessageLog$Type extends MessageType<ABCIMessageLog> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.abci.v1beta1.StringEvent events */ 3:
          message.events.push(
            StringEvent.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
          let u = options.readUnknownField
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.events.length; i++)
      StringEvent.internalBinaryWrite(
        message.events[i],
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.ABCIMessageLog
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.StringEvent
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.Attribute
 */
    ...
    super('cosmos.base.abci.v1beta1.GasInfo', [
      {
        ...
        options: { 'gogoproto.moretags': 'yaml:"gas_wanted"' },
      },
      {
        no: 2,
        name: 'gas_used',
        kind: 'scalar',
        T: 4 /*ScalarType.UINT64*/,
        options: { 'gogoproto.moretags': 'yaml:"gas_used"' },
      },
    ])
  }
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.GasInfo
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.Result
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.base.abci.v1beta1.GasInfo gas_info */ 1:
          message.gasInfo = GasInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gasInfo,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.SimulationResponse
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.MsgData
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.base.abci.v1beta1.MsgData data */ 1:
          message.data.push(
            MsgData.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
          let u = options.readUnknownField
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.TxMsgData
 */
...
class SearchTxsResult$Type extends MessageType<SearchTxsResult> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.abci.v1beta1.TxResponse txs */ 6:
          message.txs.push(
            TxResponse.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
          let u = options.readUnknownField
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.txs.length; i++)
      TxResponse.internalBinaryWrite(
        message.txs[i],
...
/**
 * @generated MessageType for protobuf messages cosmos.base.abci.v1beta1.SearchTxsResult
 */
