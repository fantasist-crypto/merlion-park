 ...
 * a version/height.
 *
 * @generated from protobuf messages cosmos.base.store.v1beta1.CommitInfo
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.store.v1beta1.StoreInfo
 */
 ...
 * committed.
 *
 * @generated from protobuf messages cosmos.base.store.v1beta1.CommitID
 */
...
class CommitInfo$Type extends MessageType<CommitInfo> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.store.v1beta1.StoreInfo store_infos */ 2:
          message.storeInfos.push(
            StoreInfo.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.storeInfos.length; i++)
      StoreInfo.internalBinaryWrite(
        message.storeInfos[i],
...
/**
 * @generated MessageType for protobuf messages cosmos.base.store.v1beta1.CommitInfo
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* cosmos.base.store.v1beta1.CommitID commit_id */ 2:
          message.commitId = CommitID.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.commitId,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.store.v1beta1.StoreInfo
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.store.v1beta1.CommitID
 */
