...
export interface IReflectionServiceClient {
  ...
  listAllInterfaces(
    ...
    options?: RpcOptions,
  ): UnaryCall<ListAllInterfacesRequest, ListAllInterfacesResponse>
  /**
  ...
  listImplementations(
    ...
    options?: RpcOptions,
  ): UnaryCall<ListImplementationsRequest, ListImplementationsResponse>
}
/**
 * ReflectionService defines a service for interface reflection.
 *
  ...
  implements IReflectionServiceClient, ServiceInfo
{
  ...
  listAllInterfaces(
    ...
    return stackIntercept<ListAllInterfacesRequest, ListAllInterfacesResponse>(
      'unary',
      this._transport,
      method,
      opt,
