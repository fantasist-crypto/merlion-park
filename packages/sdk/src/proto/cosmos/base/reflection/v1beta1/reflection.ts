 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v1beta1.ListAllInterfacesRequest
 */
export interface ListAllInterfacesRequest {}
/**
 * ListAllInterfacesResponse is the response type of the ListAllInterfaces RPC.
 *
 * @generated from protobuf messages cosmos.base.reflection.v1beta1.ListAllInterfacesResponse
 */
 ...
 * RPC.
 *
 * @generated from protobuf messages cosmos.base.reflection.v1beta1.ListImplementationsRequest
 */
 ...
 * RPC.
 *
 * @generated from protobuf messages cosmos.base.reflection.v1beta1.ListImplementationsResponse
 */
...
class ListAllInterfacesRequest$Type extends MessageType<ListAllInterfacesRequest> {
  ...
  create(
    value?: PartialMessage<ListAllInterfacesRequest>,
  ...
  internalBinaryRead(
    ...
    target?: ListAllInterfacesRequest,
  ): ListAllInterfacesRequest {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v1beta1.ListAllInterfacesRequest
 */
...
class ListAllInterfacesResponse$Type extends MessageType<ListAllInterfacesResponse> {
  ...
  create(
    value?: PartialMessage<ListAllInterfacesResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ListAllInterfacesResponse,
  ): ListAllInterfacesResponse {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v1beta1.ListAllInterfacesResponse
 */
...
class ListImplementationsRequest$Type extends MessageType<ListImplementationsRequest> {
  ...
  create(
    value?: PartialMessage<ListImplementationsRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ListImplementationsRequest,
  ): ListImplementationsRequest {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v1beta1.ListImplementationsRequest
 */
...
class ListImplementationsResponse$Type extends MessageType<ListImplementationsResponse> {
  ...
  create(
    value?: PartialMessage<ListImplementationsResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ListImplementationsResponse,
  ): ListImplementationsResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.implementationMessageNames.length; i++)
      writer
        ...
        .string(message.implementationMessageNames[i])
    let u = options.writeUnknownFields
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v1beta1.ListImplementationsResponse
 */
export const ListImplementationsResponse =
  new ListImplementationsResponse$Type()
/**
