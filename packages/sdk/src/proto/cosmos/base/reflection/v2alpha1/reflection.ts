 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.AppDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.TxDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.AuthnDescriptor
 */
 ...
 * to sign a messages given a SigningModeDescriptor, but it's better to think about
 * this another time
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.SigningModeDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.ChainDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.CodecDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.InterfaceDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.InterfaceImplementerDescriptor
 */
...
/**
 * InterfaceAcceptingMessageDescriptor describes a protobuf messages which contains
 * an interface represented as a google.protobuf.Any
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.InterfaceAcceptingMessageDescriptor
 */
export interface InterfaceAcceptingMessageDescriptor {
   ...
   * it can be in multiple fields of the same proto messages)
   *
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.ConfigurationDescriptor
 */
...
/**
 * MsgDescriptor describes a cosmos-sdk messages that can be delivered with a transaction
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.MsgDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetAuthnDescriptorRequest
 */
export interface GetAuthnDescriptorRequest {}
/**
 * GetAuthnDescriptorResponse is the response returned by the GetAuthnDescriptor RPC
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetAuthnDescriptorResponse
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetChainDescriptorRequest
 */
export interface GetChainDescriptorRequest {}
/**
 * GetChainDescriptorResponse is the response returned by the GetChainDescriptor RPC
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetChainDescriptorResponse
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetCodecDescriptorRequest
 */
export interface GetCodecDescriptorRequest {}
/**
 * GetCodecDescriptorResponse is the response returned by the GetCodecDescriptor RPC
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetCodecDescriptorResponse
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorRequest
 */
export interface GetConfigurationDescriptorRequest {}
/**
 * GetConfigurationDescriptorResponse is the response returned by the GetConfigurationDescriptor RPC
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorResponse
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorRequest
 */
export interface GetQueryServicesDescriptorRequest {}
/**
 * GetQueryServicesDescriptorResponse is the response returned by the GetQueryServicesDescriptor RPC
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorResponse
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetTxDescriptorRequest
 */
export interface GetTxDescriptorRequest {}
/**
 * GetTxDescriptorResponse is the response returned by the GetTxDescriptor RPC
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.GetTxDescriptorResponse
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.QueryServicesDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.QueryServiceDescriptor
 */
 ...
 *
 * @generated from protobuf messages cosmos.base.reflection.v2alpha1.QueryMethodDescriptor
 */
...
class AppDescriptor$Type extends MessageType<AppDescriptor> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.base.reflection.v2alpha1.AuthnDescriptor authn */ 1:
          message.authn = AuthnDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.authn,
        ...
        case /* cosmos.base.reflection.v2alpha1.ChainDescriptor chain */ 2:
          message.chain = ChainDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.chain,
        ...
        case /* cosmos.base.reflection.v2alpha1.CodecDescriptor codec */ 3:
          message.codec = CodecDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.codec,
        ...
        case /* cosmos.base.reflection.v2alpha1.ConfigurationDescriptor configuration */ 4:
          message.configuration = ConfigurationDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* cosmos.base.reflection.v2alpha1.QueryServicesDescriptor query_services */ 5:
          message.queryServices = QueryServicesDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* cosmos.base.reflection.v2alpha1.TxDescriptor tx */ 6:
          message.tx = TxDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.tx,
  ...
  internalBinaryWrite(
    ...
    if (message.authn)
      AuthnDescriptor.internalBinaryWrite(
        message.authn,
    ...
    if (message.chain)
      ChainDescriptor.internalBinaryWrite(
        message.chain,
    ...
    if (message.codec)
      CodecDescriptor.internalBinaryWrite(
        message.codec,
    ...
    if (message.configuration)
      ConfigurationDescriptor.internalBinaryWrite(
        message.configuration,
    ...
    if (message.queryServices)
      QueryServicesDescriptor.internalBinaryWrite(
        message.queryServices,
    ...
    if (message.tx)
      TxDescriptor.internalBinaryWrite(
        message.tx,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.AppDescriptor
 */
...
class TxDescriptor$Type extends MessageType<TxDescriptor> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.reflection.v2alpha1.MsgDescriptor msgs */ 2:
          message.msgs.push(
            MsgDescriptor.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        default:
          let u = options.readUnknownField
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.msgs.length; i++)
      MsgDescriptor.internalBinaryWrite(
        message.msgs[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.TxDescriptor
 */
...
class AuthnDescriptor$Type extends MessageType<AuthnDescriptor> {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.base.reflection.v2alpha1.SigningModeDescriptor sign_modes */ 1:
          message.signModes.push(
            SigningModeDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.signModes.length; i++)
      SigningModeDescriptor.internalBinaryWrite(
        message.signModes[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.AuthnDescriptor
 */
  ...
  internalBinaryWrite(
    ...
    if (message.authnInfoProviderMethodFullname !== '')
      writer
        ...
        .string(message.authnInfoProviderMethodFullname)
    let u = options.writeUnknownFields
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.SigningModeDescriptor
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.ChainDescriptor
 */
...
class CodecDescriptor$Type extends MessageType<CodecDescriptor> {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.base.reflection.v2alpha1.InterfaceDescriptor interfaces */ 1:
          message.interfaces.push(
            InterfaceDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.interfaces.length; i++)
      InterfaceDescriptor.internalBinaryWrite(
        message.interfaces[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
    let u = options.writeUnknownFields
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.CodecDescriptor
 */
...
class InterfaceDescriptor$Type extends MessageType<InterfaceDescriptor> {
  constructor() {
    super('cosmos.base.reflection.v2alpha1.InterfaceDescriptor', [
      ...
      },
      {
        ...
        kind: 'message',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => InterfaceImplementerDescriptor,
      },
    ])
  }
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.reflection.v2alpha1.InterfaceAcceptingMessageDescriptor interface_accepting_messages */ 2:
          message.interfaceAcceptingMessages.push(
            InterfaceAcceptingMessageDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* repeated cosmos.base.reflection.v2alpha1.InterfaceImplementerDescriptor interface_implementers */ 3:
          message.interfaceImplementers.push(
            InterfaceImplementerDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.interfaceAcceptingMessages.length; i++)
      InterfaceAcceptingMessageDescriptor.internalBinaryWrite(
        message.interfaceAcceptingMessages[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
    ...
    for (let i = 0; i < message.interfaceImplementers.length; i++)
      InterfaceImplementerDescriptor.internalBinaryWrite(
        message.interfaceImplementers[i],
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join()
    let u = options.writeUnknownFields
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.InterfaceDescriptor
 */
...
class InterfaceImplementerDescriptor$Type extends MessageType<InterfaceImplementerDescriptor> {
  ...
  create(
    value?: PartialMessage<InterfaceImplementerDescriptor>,
    ...
    if (value !== undefined)
      reflectionMergePartial<InterfaceImplementerDescriptor>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: InterfaceImplementerDescriptor,
  ): InterfaceImplementerDescriptor {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.InterfaceImplementerDescriptor
 */
export const InterfaceImplementerDescriptor =
  new InterfaceImplementerDescriptor$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class InterfaceAcceptingMessageDescriptor$Type extends MessageType<InterfaceAcceptingMessageDescriptor> {
  ...
  create(
    value?: PartialMessage<InterfaceAcceptingMessageDescriptor>,
    ...
    if (value !== undefined)
      reflectionMergePartial<InterfaceAcceptingMessageDescriptor>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: InterfaceAcceptingMessageDescriptor,
  ): InterfaceAcceptingMessageDescriptor {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.fieldDescriptorNames.length; i++)
      writer
        ...
        .string(message.fieldDescriptorNames[i])
    let u = options.writeUnknownFields
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.InterfaceAcceptingMessageDescriptor
 */
export const InterfaceAcceptingMessageDescriptor =
  new InterfaceAcceptingMessageDescriptor$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class ConfigurationDescriptor$Type extends MessageType<ConfigurationDescriptor> {
  ...
  create(
    value?: PartialMessage<ConfigurationDescriptor>,
  ...
  internalBinaryWrite(
    ...
    if (message.bech32AccountAddressPrefix !== '')
      writer
        ...
        .string(message.bech32AccountAddressPrefix)
    let u = options.writeUnknownFields
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.ConfigurationDescriptor
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.MsgDescriptor
 */
...
class GetAuthnDescriptorRequest$Type extends MessageType<GetAuthnDescriptorRequest> {
  ...
  create(
    value?: PartialMessage<GetAuthnDescriptorRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetAuthnDescriptorRequest,
  ): GetAuthnDescriptorRequest {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetAuthnDescriptorRequest
 */
...
class GetAuthnDescriptorResponse$Type extends MessageType<GetAuthnDescriptorResponse> {
  ...
  create(
    value?: PartialMessage<GetAuthnDescriptorResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetAuthnDescriptorResponse,
  ): GetAuthnDescriptorResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetAuthnDescriptorResponse
 */
...
class GetChainDescriptorRequest$Type extends MessageType<GetChainDescriptorRequest> {
  ...
  create(
    value?: PartialMessage<GetChainDescriptorRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetChainDescriptorRequest,
  ): GetChainDescriptorRequest {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetChainDescriptorRequest
 */
...
class GetChainDescriptorResponse$Type extends MessageType<GetChainDescriptorResponse> {
  ...
  create(
    value?: PartialMessage<GetChainDescriptorResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetChainDescriptorResponse,
  ): GetChainDescriptorResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetChainDescriptorResponse
 */
...
class GetCodecDescriptorRequest$Type extends MessageType<GetCodecDescriptorRequest> {
  ...
  create(
    value?: PartialMessage<GetCodecDescriptorRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetCodecDescriptorRequest,
  ): GetCodecDescriptorRequest {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetCodecDescriptorRequest
 */
...
class GetCodecDescriptorResponse$Type extends MessageType<GetCodecDescriptorResponse> {
  ...
  create(
    value?: PartialMessage<GetCodecDescriptorResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetCodecDescriptorResponse,
  ): GetCodecDescriptorResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetCodecDescriptorResponse
 */
...
class GetConfigurationDescriptorRequest$Type extends MessageType<GetConfigurationDescriptorRequest> {
  ...
  create(
    value?: PartialMessage<GetConfigurationDescriptorRequest>,
    ...
    if (value !== undefined)
      reflectionMergePartial<GetConfigurationDescriptorRequest>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetConfigurationDescriptorRequest,
  ): GetConfigurationDescriptorRequest {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorRequest
 */
export const GetConfigurationDescriptorRequest =
  new GetConfigurationDescriptorRequest$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class GetConfigurationDescriptorResponse$Type extends MessageType<GetConfigurationDescriptorResponse> {
  ...
  create(
    value?: PartialMessage<GetConfigurationDescriptorResponse>,
    ...
    if (value !== undefined)
      reflectionMergePartial<GetConfigurationDescriptorResponse>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetConfigurationDescriptorResponse,
  ): GetConfigurationDescriptorResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.base.reflection.v2alpha1.ConfigurationDescriptor config */ 1:
          message.config = ConfigurationDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.config,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorResponse
 */
export const GetConfigurationDescriptorResponse =
  new GetConfigurationDescriptorResponse$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class GetQueryServicesDescriptorRequest$Type extends MessageType<GetQueryServicesDescriptorRequest> {
  ...
  create(
    value?: PartialMessage<GetQueryServicesDescriptorRequest>,
    ...
    if (value !== undefined)
      reflectionMergePartial<GetQueryServicesDescriptorRequest>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetQueryServicesDescriptorRequest,
  ): GetQueryServicesDescriptorRequest {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorRequest
 */
export const GetQueryServicesDescriptorRequest =
  new GetQueryServicesDescriptorRequest$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class GetQueryServicesDescriptorResponse$Type extends MessageType<GetQueryServicesDescriptorResponse> {
  ...
  create(
    value?: PartialMessage<GetQueryServicesDescriptorResponse>,
    ...
    if (value !== undefined)
      reflectionMergePartial<GetQueryServicesDescriptorResponse>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetQueryServicesDescriptorResponse,
  ): GetQueryServicesDescriptorResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.base.reflection.v2alpha1.QueryServicesDescriptor queries */ 1:
          message.queries = QueryServicesDescriptor.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.queries,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorResponse
 */
export const GetQueryServicesDescriptorResponse =
  new GetQueryServicesDescriptorResponse$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class GetTxDescriptorRequest$Type extends MessageType<GetTxDescriptorRequest> {
  ...
  create(
    value?: PartialMessage<GetTxDescriptorRequest>,
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetTxDescriptorRequest
 */
...
class GetTxDescriptorResponse$Type extends MessageType<GetTxDescriptorResponse> {
  ...
  create(
    value?: PartialMessage<GetTxDescriptorResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetTxDescriptorResponse,
  ): GetTxDescriptorResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.GetTxDescriptorResponse
 */
...
class QueryServicesDescriptor$Type extends MessageType<QueryServicesDescriptor> {
    ...
    super('cosmos.base.reflection.v2alpha1.QueryServicesDescriptor', [
      {
        ...
        kind: 'message',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => QueryServiceDescriptor,
      },
    ])
  }
  create(
    value?: PartialMessage<QueryServicesDescriptor>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: QueryServicesDescriptor,
  ): QueryServicesDescriptor {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.base.reflection.v2alpha1.QueryServiceDescriptor query_services */ 1:
          message.queryServices.push(
            QueryServiceDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.queryServices.length; i++)
      QueryServiceDescriptor.internalBinaryWrite(
        message.queryServices[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
    let u = options.writeUnknownFields
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.QueryServicesDescriptor
 */
...
class QueryServiceDescriptor$Type extends MessageType<QueryServiceDescriptor> {
  constructor() {
    super('cosmos.base.reflection.v2alpha1.QueryServiceDescriptor', [
      ...
      { no: 2, name: 'is_module', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
      {
        ...
        kind: 'message',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => QueryMethodDescriptor,
      },
    ])
  }
  create(
    value?: PartialMessage<QueryServiceDescriptor>,
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.base.reflection.v2alpha1.QueryMethodDescriptor methods */ 3:
          message.methods.push(
            QueryMethodDescriptor.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.methods.length; i++)
      QueryMethodDescriptor.internalBinaryWrite(
        message.methods[i],
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.QueryServiceDescriptor
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.base.reflection.v2alpha1.QueryMethodDescriptor
 */
 ...
 */
export const ReflectionService = new ServiceType(
