...
export interface IReflectionServiceClient {
  ...
  getAuthnDescriptor(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetAuthnDescriptorRequest, GetAuthnDescriptorResponse>
  /**
  ...
  getChainDescriptor(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetChainDescriptorRequest, GetChainDescriptorResponse>
  /**
  ...
  getCodecDescriptor(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetCodecDescriptorRequest, GetCodecDescriptorResponse>
  /**
  ...
  getTxDescriptor(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetTxDescriptorRequest, GetTxDescriptorResponse>
}
/**
 * ReflectionService defines a service for application reflection.
 *
...
export class ReflectionServiceClient
  implements IReflectionServiceClient, ServiceInfo
{
  ...
  getTxDescriptor(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<GetTxDescriptorRequest, GetTxDescriptorResponse>(
      'unary',
      this._transport,
      method,
      opt,
