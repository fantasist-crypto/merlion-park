...
export interface IMsgClient {
  ...
  send(
    input: MsgSend,
    options?: RpcOptions,
  ): UnaryCall<MsgSend, MsgSendResponse>
  /**
  ...
  multiSend(
    input: MsgMultiSend,
    options?: RpcOptions,
  ): UnaryCall<MsgMultiSend, MsgMultiSendResponse>
}
/**
 * Msg defines the bank Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  send(
    ...
    return stackIntercept<MsgSend, MsgSendResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  multiSend(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgMultiSend, MsgMultiSendResponse>(
      'unary',
      this._transport,
      method,
      opt,
