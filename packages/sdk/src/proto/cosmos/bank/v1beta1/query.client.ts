...
export interface IQueryClient {
  ...
  allBalances(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryAllBalancesRequest, QueryAllBalancesResponse>
  /**
  ...
  supplyOf(
    ...
    options?: RpcOptions,
  ): UnaryCall<QuerySupplyOfRequest, QuerySupplyOfResponse>
  /**
  ...
  denomMetadata(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryDenomMetadataRequest, QueryDenomMetadataResponse>
  /**
  ...
  denomsMetadata(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryDenomsMetadataRequest, QueryDenomsMetadataResponse>
}
/**
 * Query defines the gRPC querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  allBalances(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryAllBalancesRequest, QueryAllBalancesResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  supplyOf(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QuerySupplyOfRequest, QuerySupplyOfResponse>(
      'unary',
      this._transport,
      method,
      opt,
