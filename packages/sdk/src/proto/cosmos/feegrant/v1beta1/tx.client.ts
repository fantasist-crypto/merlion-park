...
export interface IMsgClient {
  ...
  grantAllowance(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgGrantAllowance, MsgGrantAllowanceResponse>
  /**
  ...
  revokeAllowance(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgRevokeAllowance, MsgRevokeAllowanceResponse>
}
/**
 * Msg defines the feegrant msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  grantAllowance(
    ...
    return stackIntercept<MsgGrantAllowance, MsgGrantAllowanceResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  revokeAllowance(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgRevokeAllowance, MsgRevokeAllowanceResponse>(
      'unary',
      this._transport,
      method,
      opt,
