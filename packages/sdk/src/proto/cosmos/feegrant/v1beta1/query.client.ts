...
export interface IQueryClient {
  ...
  allowance(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryAllowanceRequest, QueryAllowanceResponse>
  /**
  ...
  allowances(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryAllowancesRequest, QueryAllowancesResponse>
}
/**
 * Query defines the gRPC querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  allowance(
    ...
    return stackIntercept<QueryAllowanceRequest, QueryAllowanceResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  allowances(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryAllowancesRequest, QueryAllowancesResponse>(
      'unary',
      this._transport,
      method,
      opt,
