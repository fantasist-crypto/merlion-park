 ...
 * then you must create a new proto messages and follow ADR-28 for Address construction.
 *
 * @generated from protobuf messages cosmos.crypto.ed25519.PubKey
 */
 ...
 *
 * @generated from protobuf messages cosmos.crypto.ed25519.PrivKey
 */
      ...
      [
        {
          ...
          options: { 'gogoproto.casttype': 'crypto/ed25519.PublicKey' },
        },
      ],
...
/**
 * @generated MessageType for protobuf messages cosmos.crypto.ed25519.PubKey
 */
    ...
    super('cosmos.crypto.ed25519.PrivKey', [
      {
        ...
        kind: 'scalar',
        T: 12 /*ScalarType.BYTES*/,
        options: { 'gogoproto.casttype': 'crypto/ed25519.PrivateKey' },
      },
    ])
  }
...
/**
 * @generated MessageType for protobuf messages cosmos.crypto.ed25519.PrivKey
 */
