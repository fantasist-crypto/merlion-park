...
export interface IQueryClient {
  ...
  signingInfo(
    ...
    options?: RpcOptions,
  ): UnaryCall<QuerySigningInfoRequest, QuerySigningInfoResponse>
  /**
  ...
  signingInfos(
    ...
    options?: RpcOptions,
  ): UnaryCall<QuerySigningInfosRequest, QuerySigningInfosResponse>
}
/**
 * Query provides defines the gRPC querier service
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  signingInfo(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QuerySigningInfoRequest, QuerySigningInfoResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  signingInfos(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QuerySigningInfosRequest, QuerySigningInfosResponse>(
      'unary',
      this._transport,
      method,
      opt,
