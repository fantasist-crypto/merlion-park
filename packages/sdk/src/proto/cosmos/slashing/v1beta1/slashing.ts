 ...
 * liveness activity.
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.ValidatorSigningInfo
 */
 ...
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.Params
 */
    ...
    super(
      ...
      [
        { no: 1, name: 'address', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
        {
          ...
          options: { 'gogoproto.moretags': 'yaml:"start_height"' },
        },
        {
          no: 3,
          name: 'index_offset',
          kind: 'scalar',
          T: 3 /*ScalarType.INT64*/,
          options: { 'gogoproto.moretags': 'yaml:"index_offset"' },
        },
        {
          no: 4,
          name: 'jailed_until',
        ...
        { no: 5, name: 'tombstoned', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
        {
          ...
          kind: 'scalar',
          T: 3 /*ScalarType.INT64*/,
          options: { 'gogoproto.moretags': 'yaml:"missed_blocks_counter"' },
        },
      ],
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Timestamp jailed_until */ 4:
          message.jailedUntil = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.jailedUntil,
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.ValidatorSigningInfo
 */
    ...
    super('cosmos.slashing.v1beta1.Params', [
      {
        ...
        kind: 'scalar',
        T: 3 /*ScalarType.INT64*/,
        options: { 'gogoproto.moretags': 'yaml:"signed_blocks_window"' },
      },
      {
        no: 2,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Duration downtime_jail_duration */ 3:
          message.downtimeJailDuration = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.Params
 */
