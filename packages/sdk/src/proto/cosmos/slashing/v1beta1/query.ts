 ...
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.QueryParamsRequest
 */
export interface QueryParamsRequest {}
/**
 * QueryParamsResponse is the response type for the Query/Params RPC method
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.QueryParamsResponse
 */
 ...
 * method
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.QuerySigningInfoRequest
 */
 ...
 * method
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.QuerySigningInfoResponse
 */
 ...
 * method
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.QuerySigningInfosRequest
 */
 ...
 * method
 *
 * @generated from protobuf messages cosmos.slashing.v1beta1.QuerySigningInfosResponse
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.QueryParamsRequest
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.QueryParamsResponse
 */
...
class QuerySigningInfoRequest$Type extends MessageType<QuerySigningInfoRequest> {
  ...
  create(
    value?: PartialMessage<QuerySigningInfoRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: QuerySigningInfoRequest,
  ): QuerySigningInfoRequest {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.QuerySigningInfoRequest
 */
...
class QuerySigningInfoResponse$Type extends MessageType<QuerySigningInfoResponse> {
  ...
  create(
    value?: PartialMessage<QuerySigningInfoResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: QuerySigningInfoResponse,
  ): QuerySigningInfoResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.slashing.v1beta1.ValidatorSigningInfo val_signing_info */ 1:
          message.valSigningInfo = ValidatorSigningInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.valSigningInfo)
      ValidatorSigningInfo.internalBinaryWrite(
        message.valSigningInfo,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.QuerySigningInfoResponse
 */
...
class QuerySigningInfosRequest$Type extends MessageType<QuerySigningInfosRequest> {
  ...
  create(
    value?: PartialMessage<QuerySigningInfosRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: QuerySigningInfosRequest,
  ): QuerySigningInfosRequest {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.QuerySigningInfosRequest
 */
...
class QuerySigningInfosResponse$Type extends MessageType<QuerySigningInfosResponse> {
  ...
  create(
    value?: PartialMessage<QuerySigningInfosResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: QuerySigningInfosResponse,
  ): QuerySigningInfosResponse {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated cosmos.slashing.v1beta1.ValidatorSigningInfo info */ 1:
          message.info.push(
            ValidatorSigningInfo.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
...
/**
 * @generated MessageType for protobuf messages cosmos.slashing.v1beta1.QuerySigningInfosResponse
 */
...
export const Query = new ServiceType('cosmos.slashing.v1beta1.Query', [
  {
    name: 'Params',
    options: { 'google.api.http': { get: '/cosmos/slashing/v1beta1/params' } },
