...
export interface IQueryClient {
  ...
  currentPlan(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryCurrentPlanRequest, QueryCurrentPlanResponse>
  /**
  ...
  appliedPlan(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryAppliedPlanRequest, QueryAppliedPlanResponse>
  /**
  ...
  moduleVersions(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryModuleVersionsRequest, QueryModuleVersionsResponse>
}
/**
 * Query defines the gRPC upgrade querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  currentPlan(
    ...
    return stackIntercept<QueryCurrentPlanRequest, QueryCurrentPlanResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  appliedPlan(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryAppliedPlanRequest, QueryAppliedPlanResponse>(
      'unary',
      this._transport,
      method,
      opt,
