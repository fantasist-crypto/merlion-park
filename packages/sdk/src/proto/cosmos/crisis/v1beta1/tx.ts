...
/**
 * MsgVerifyInvariant represents a messages to verify a particular invariance.
 *
 * @generated from protobuf messages cosmos.crisis.v1beta1.MsgVerifyInvariant
 */
 ...
 *
 * @generated from protobuf messages cosmos.crisis.v1beta1.MsgVerifyInvariantResponse
 */
    ...
    super(
      ...
      [
        { no: 1, name: 'sender', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
        {
          ...
          options: { 'gogoproto.moretags': 'yaml:"invariant_module_name"' },
        },
        {
          no: 3,
          ...
          kind: 'scalar',
          T: 9 /*ScalarType.STRING*/,
          options: { 'gogoproto.moretags': 'yaml:"invariant_route"' },
        },
      ],
  ...
  internalBinaryWrite(
    ...
    if (message.invariantModuleName !== '')
      writer
        ...
        .string(message.invariantModuleName)
...
/**
 * @generated MessageType for protobuf messages cosmos.crisis.v1beta1.MsgVerifyInvariant
 */
...
class MsgVerifyInvariantResponse$Type extends MessageType<MsgVerifyInvariantResponse> {
  ...
  create(
    value?: PartialMessage<MsgVerifyInvariantResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MsgVerifyInvariantResponse,
  ): MsgVerifyInvariantResponse {
...
/**
 * @generated MessageType for protobuf messages cosmos.crisis.v1beta1.MsgVerifyInvariantResponse
 */
