 ...
 *
 * @generated from protobuf messages cosmos.crisis.v1beta1.GenesisState
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.base.v1beta1.Coin constant_fee */ 3:
          message.constantFee = Coin.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.constantFee,
...
/**
 * @generated MessageType for protobuf messages cosmos.crisis.v1beta1.GenesisState
 */
