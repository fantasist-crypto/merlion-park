 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.WeightedVoteOption
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.TextProposal
 */
 ...
 * proposal.
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.Deposit
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.Proposal
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.TallyResult
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.Vote
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.DepositParams
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.VotingParams
 */
 ...
 *
 * @generated from protobuf messages cosmos.gov.v1beta1.TallyParams
 */
    ...
    super('cosmos.gov.v1beta1.WeightedVoteOption', [
      {
        ...
        name: 'option',
        kind: 'enum',
        T: () => ['cosmos.gov.v1beta1.VoteOption', VoteOption, 'VOTE_OPTION_'],
      },
      {
        no: 2,
        name: 'weight',
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.WeightedVoteOption
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.TextProposal
 */
      ...
      [
        {
          ...
          options: { 'gogoproto.moretags': 'yaml:"proposal_id"' },
        },
        {
          no: 2,
          name: 'depositor',
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.Deposit
 */
    ...
    super(
      ...
      [
        ...
        },
        {
          ...
          kind: 'message',
          T: () => Any,
          options: { 'cosmos_proto.accepts_interface': 'Content' },
        },
        {
          no: 3,
          name: 'status',
          ...
          options: { 'gogoproto.moretags': 'yaml:"proposal_status"' },
        },
        {
          no: 4,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Any content */ 2:
          message.content = Any.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.content,
        ...
        case /* cosmos.gov.v1beta1.TallyResult final_tally_result */ 4:
          message.finalTallyResult = TallyResult.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* google.protobuf.Timestamp submit_time */ 5:
          message.submitTime = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.submitTime,
        ...
        case /* google.protobuf.Timestamp deposit_end_time */ 6:
          message.depositEndTime = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* google.protobuf.Timestamp voting_start_time */ 8:
          message.votingStartTime = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* google.protobuf.Timestamp voting_end_time */ 9:
          message.votingEndTime = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.Proposal
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.TallyResult
 */
...
class Vote$Type extends MessageType<Vote> {
  ...
  create(value?: PartialMessage<Vote>): Vote {
    ...
    if (value !== undefined) reflectionMergePartial<Vote>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.gov.v1beta1.WeightedVoteOption options */ 4:
          message.options.push(
            WeightedVoteOption.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.options.length; i++)
      WeightedVoteOption.internalBinaryWrite(
        message.options[i],
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.Vote
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Duration max_deposit_period */ 2:
          message.maxDepositPeriod = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.DepositParams
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.Duration voting_period */ 1:
          message.votingPeriod = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.VotingParams
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.gov.v1beta1.TallyParams
 */
