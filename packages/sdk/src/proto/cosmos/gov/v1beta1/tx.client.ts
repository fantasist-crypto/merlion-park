...
export interface IMsgClient {
  ...
  submitProposal(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgSubmitProposal, MsgSubmitProposalResponse>
  /**
  ...
  vote(
    input: MsgVote,
    options?: RpcOptions,
  ): UnaryCall<MsgVote, MsgVoteResponse>
  /**
  ...
  voteWeighted(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgVoteWeighted, MsgVoteWeightedResponse>
  /**
  ...
  deposit(
    input: MsgDeposit,
    options?: RpcOptions,
  ): UnaryCall<MsgDeposit, MsgDepositResponse>
}
/**
 * Msg defines the bank Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  submitProposal(
    ...
    return stackIntercept<MsgSubmitProposal, MsgSubmitProposalResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  vote(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgVote, MsgVoteResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  voteWeighted(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgVoteWeighted, MsgVoteWeightedResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  deposit(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgDeposit, MsgDepositResponse>(
      'unary',
      this._transport,
      method,
      opt,
