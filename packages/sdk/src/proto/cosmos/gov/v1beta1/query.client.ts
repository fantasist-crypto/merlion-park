...
export interface IQueryClient {
  ...
  proposal(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryProposalRequest, QueryProposalResponse>
  /**
  ...
  proposals(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryProposalsRequest, QueryProposalsResponse>
  /**
  ...
  vote(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryVoteRequest, QueryVoteResponse>
  /**
  ...
  votes(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryVotesRequest, QueryVotesResponse>
  /**
  ...
  deposit(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryDepositRequest, QueryDepositResponse>
  /**
  ...
  deposits(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryDepositsRequest, QueryDepositsResponse>
  /**
  ...
  tallyResult(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryTallyResultRequest, QueryTallyResultResponse>
}
/**
 * Query defines the gRPC querier service for gov module
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  proposal(
    ...
    return stackIntercept<QueryProposalRequest, QueryProposalResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  proposals(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryProposalsRequest, QueryProposalsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  vote(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryVoteRequest, QueryVoteResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  votes(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryVotesRequest, QueryVotesResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  deposit(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryDepositRequest, QueryDepositResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  deposits(
    ...
    const method = this.methods[6],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryDepositsRequest, QueryDepositsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  tallyResult(
    ...
    const method = this.methods[7],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryTallyResultRequest, QueryTallyResultResponse>(
      'unary',
      this._transport,
      method,
      opt,
