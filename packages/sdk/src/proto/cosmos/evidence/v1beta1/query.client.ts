...
export interface IQueryClient {
  ...
  evidence(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryEvidenceRequest, QueryEvidenceResponse>
  /**
  ...
  allEvidence(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryAllEvidenceRequest, QueryAllEvidenceResponse>
}
/**
 * Query defines the gRPC querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  evidence(
    ...
    return stackIntercept<QueryEvidenceRequest, QueryEvidenceResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  allEvidence(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryAllEvidenceRequest, QueryAllEvidenceResponse>(
      'unary',
      this._transport,
      method,
      opt,
