...
export interface IMsgClient {
  ...
  grant(
    input: MsgGrant,
    options?: RpcOptions,
  ): UnaryCall<MsgGrant, MsgGrantResponse>
  /**
  ...
  exec(
    input: MsgExec,
    options?: RpcOptions,
  ): UnaryCall<MsgExec, MsgExecResponse>
  /**
  ...
  revoke(
    input: MsgRevoke,
    options?: RpcOptions,
  ): UnaryCall<MsgRevoke, MsgRevokeResponse>
}
/**
 * Msg defines the authz Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  grant(
    ...
    return stackIntercept<MsgGrant, MsgGrantResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  exec(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgExec, MsgExecResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  revoke(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgRevoke, MsgRevokeResponse>(
      'unary',
      this._transport,
      method,
      opt,
