...
export interface IQueryClient {
  ...
  inflation(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryInflationRequest, QueryInflationResponse>
  /**
  ...
  annualProvisions(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryAnnualProvisionsRequest, QueryAnnualProvisionsResponse>
}
/**
 * Query provides defines the gRPC querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  inflation(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryInflationRequest, QueryInflationResponse>(
      'unary',
      this._transport,
      method,
      opt,
