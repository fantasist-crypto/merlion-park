...
export interface IMsgClient {
  ...
  setWithdrawAddress(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgSetWithdrawAddress, MsgSetWithdrawAddressResponse>
  /**
  ...
  withdrawDelegatorReward(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgWithdrawDelegatorReward, MsgWithdrawDelegatorRewardResponse>
  /**
  ...
  fundCommunityPool(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgFundCommunityPool, MsgFundCommunityPoolResponse>
}
/**
 * Msg defines the distribution Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  setWithdrawAddress(
    ...
    return stackIntercept<MsgSetWithdrawAddress, MsgSetWithdrawAddressResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  fundCommunityPool(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgFundCommunityPool, MsgFundCommunityPoolResponse>(
      'unary',
      this._transport,
      method,
      opt,
