...
export interface IQueryClient {
  ...
  validatorSlashes(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryValidatorSlashesRequest, QueryValidatorSlashesResponse>
  /**
  ...
  delegationRewards(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryDelegationRewardsRequest, QueryDelegationRewardsResponse>
  /**
  ...
  communityPool(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryCommunityPoolRequest, QueryCommunityPoolResponse>
}
/**
 * Query defines the gRPC querier service for distribution module.
 *
