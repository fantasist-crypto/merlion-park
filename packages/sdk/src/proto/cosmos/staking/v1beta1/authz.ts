 ...
 *
 * @generated from protobuf messages cosmos.staking.v1beta1.StakeAuthorization
 */
 ...
 *
 * @generated from protobuf messages cosmos.staking.v1beta1.StakeAuthorization.Validators
 */
...
class StakeAuthorization$Type extends MessageType<StakeAuthorization> {
  ...
  create(value?: PartialMessage<StakeAuthorization>): StakeAuthorization {
    const message = {
      validators: { oneofKind: undefined },
      authorizationType: 0,
    }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* cosmos.base.v1beta1.Coin max_tokens */ 1:
          message.maxTokens = Coin.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.maxTokens,
        ...
        case /* cosmos.staking.v1beta1.StakeAuthorization.Validators allow_list */ 2:
          message.validators = {
            oneofKind: 'allowList',
            allowList: StakeAuthorization_Validators.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.validators as any).allowList,
            ),
          }
          break
        case /* cosmos.staking.v1beta1.StakeAuthorization.Validators deny_list */ 3:
          message.validators = {
            oneofKind: 'denyList',
            denyList: StakeAuthorization_Validators.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.validators as any).denyList,
            ),
          }
          break
  ...
  internalBinaryWrite(
    ...
    if (message.validators.oneofKind === 'allowList')
      StakeAuthorization_Validators.internalBinaryWrite(
        message.validators.allowList,
...
/**
 * @generated MessageType for protobuf messages cosmos.staking.v1beta1.StakeAuthorization
 */
...
class StakeAuthorization_Validators$Type extends MessageType<StakeAuthorization_Validators> {
  ...
  create(
    value?: PartialMessage<StakeAuthorization_Validators>,
    ...
    if (value !== undefined)
      reflectionMergePartial<StakeAuthorization_Validators>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: StakeAuthorization_Validators,
  ): StakeAuthorization_Validators {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages cosmos.staking.v1beta1.StakeAuthorization.Validators
 */
export const StakeAuthorization_Validators =
  new StakeAuthorization_Validators$Type()
