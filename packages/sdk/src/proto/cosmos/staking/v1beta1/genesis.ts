 ...
 *
 * @generated from protobuf messages cosmos.staking.v1beta1.GenesisState
 */
 ...
 *
 * @generated from protobuf messages cosmos.staking.v1beta1.LastValidatorPower
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
      ...
      switch (fieldNo) {
        ...
        case /* repeated cosmos.staking.v1beta1.LastValidatorPower last_validator_powers */ 3:
          message.lastValidatorPowers.push(
            LastValidatorPower.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* repeated cosmos.staking.v1beta1.Delegation delegations */ 5:
          message.delegations.push(
            Delegation.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        ...
        case /* repeated cosmos.staking.v1beta1.Redelegation redelegations */ 7:
          message.redelegations.push(
            Redelegation.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.lastValidatorPowers.length; i++)
      LastValidatorPower.internalBinaryWrite(
        message.lastValidatorPowers[i],
    ...
    for (let i = 0; i < message.unbondingDelegations.length; i++)
      UnbondingDelegation.internalBinaryWrite(
        message.unbondingDelegations[i],
...
/**
 * @generated MessageType for protobuf messages cosmos.staking.v1beta1.GenesisState
 */
...
/**
 * @generated MessageType for protobuf messages cosmos.staking.v1beta1.LastValidatorPower
 */
