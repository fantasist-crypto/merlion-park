...
export interface IMsgClient {
  ...
  createValidator(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgCreateValidator, MsgCreateValidatorResponse>
  /**
  ...
  editValidator(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgEditValidator, MsgEditValidatorResponse>
  /**
  ...
  delegate(
    input: MsgDelegate,
    options?: RpcOptions,
  ): UnaryCall<MsgDelegate, MsgDelegateResponse>
  /**
  ...
  beginRedelegate(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgBeginRedelegate, MsgBeginRedelegateResponse>
  /**
  ...
  undelegate(
    input: MsgUndelegate,
    options?: RpcOptions,
  ): UnaryCall<MsgUndelegate, MsgUndelegateResponse>
}
/**
 * Msg defines the staking Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  createValidator(
    ...
    return stackIntercept<MsgCreateValidator, MsgCreateValidatorResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  editValidator(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgEditValidator, MsgEditValidatorResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  delegate(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgDelegate, MsgDelegateResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  beginRedelegate(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgBeginRedelegate, MsgBeginRedelegateResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  undelegate(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgUndelegate, MsgUndelegateResponse>(
      'unary',
      this._transport,
      method,
      opt,
