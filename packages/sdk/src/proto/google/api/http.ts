 ...
 *
 * @generated from protobuf messages google.api.Http
 */
 ...
 * messages, as in the example below which describes a REST GET
 ...
 * repeated and must have a primitive (non-messages) type.
 *
 * Any fields in the request messages which are not bound by the path
 * pattern automatically become (optional) HTTP query
 * parameters. Assume the following definition of the request messages:
 *
 *
 *     service Messaging {
 *       rpc GetMessage(GetMessageRequest) returns (Message) {
 ...
 *       string message_id = 1; // mapped to the URL
 *       Message messages = 2;   // mapped to the body
 *     }
 *
 *
 ...
 * to the request messages are as follows:
 *
 ...
 *
 * @generated from protobuf messages google.api.HttpRule
 */
export interface HttpRule {
   ...
   * present at the top-level of request messages type.
   *
   ...
   * not set, the response messages will be used as HTTP body of response.
   *
 ...
 *
 * @generated from protobuf messages google.api.CustomHttpPattern
 */
...
/**
 * @generated MessageType for protobuf messages google.api.Http
 */
...
/**
 * @generated MessageType for protobuf messages google.api.HttpRule
 */
...
/**
 * @generated MessageType for protobuf messages google.api.CustomHttpPattern
 */
