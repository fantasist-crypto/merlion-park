...
// @generated from protobuf file "merlion/voter/v1/query.proto" (package "merlion.voter.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message merlion.voter.v1.QueryParamsRequest
 */
 ...
 *
 * @generated from protobuf message merlion.voter.v1.QueryParamsResponse
 */
...
class QueryParamsRequest$Type extends MessageType<QueryParamsRequest> {
    constructor() {
        super("merlion.voter.v1.QueryParamsRequest", []);
    }
...
/**
 * @generated MessageType for protobuf message merlion.voter.v1.QueryParamsRequest
 */
...
class QueryParamsResponse$Type extends MessageType<QueryParamsResponse> {
    constructor() {
        super("merlion.voter.v1.QueryParamsResponse", [
...
/**
 * @generated MessageType for protobuf message merlion.voter.v1.QueryParamsResponse
 */
export const QueryParamsResponse = new QueryParamsResponse$Type();
/**
 * @generated ServiceType for protobuf service merlion.voter.v1.Query
 */
export const Query = new ServiceType("merlion.voter.v1.Query", [
    { name: "Params", options: { "google.api.http": { get: "/merlion/voter/v1/params" } }, I: QueryParamsRequest, O: QueryParamsResponse }
]);
