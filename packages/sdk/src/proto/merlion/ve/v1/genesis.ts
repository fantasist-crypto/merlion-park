...
// @generated from protobuf file "merlion/ve/v1/genesis.proto" (package "merlion.ve.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message merlion.ve.v1.GenesisState
 */
 ...
 *
 * @generated from protobuf message merlion.ve.v1.Params
 */
export interface Params {
    /**
     * @generated from protobuf field: string lock_denom = 1;
     */
    lockDenom: string;
}
...
class GenesisState$Type extends MessageType<GenesisState> {
    constructor() {
        super("merlion.ve.v1.GenesisState", [
...
/**
 * @generated MessageType for protobuf message merlion.ve.v1.GenesisState
 */
export const GenesisState = new GenesisState$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Params$Type extends MessageType<Params> {
    constructor() {
        super("merlion.ve.v1.Params", [
            { no: 1, name: "lock_denom", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "gogoproto.goproto_stringer": false });
    }
    create(value?: PartialMessage<Params>): Params {
        const message = { lockDenom: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.lockDenom !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.lockDenom);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message merlion.ve.v1.Params
 */
