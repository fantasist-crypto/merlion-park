 ...
 *
 * @generated from protobuf service merlion.gauge.v1.Query
 */
export interface IQueryClient {
    /**
     * Parameters queries the parameters of the module.
     *
     * @generated from protobuf rpc: Params(merlion.gauge.v1.QueryParamsRequest) returns (merlion.gauge.v1.QueryParamsResponse);
     */
