...
// @generated from protobuf file "merlion/gauge/v1/query.proto" (package "merlion.gauge.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message merlion.gauge.v1.QueryParamsRequest
 */
 ...
 *
 * @generated from protobuf message merlion.gauge.v1.QueryParamsResponse
 */
...
class QueryParamsRequest$Type extends MessageType<QueryParamsRequest> {
    constructor() {
        super("merlion.gauge.v1.QueryParamsRequest", []);
    }
...
/**
 * @generated MessageType for protobuf message merlion.gauge.v1.QueryParamsRequest
 */
...
class QueryParamsResponse$Type extends MessageType<QueryParamsResponse> {
    constructor() {
        super("merlion.gauge.v1.QueryParamsResponse", [
...
/**
 * @generated MessageType for protobuf message merlion.gauge.v1.QueryParamsResponse
 */
export const QueryParamsResponse = new QueryParamsResponse$Type();
/**
 * @generated ServiceType for protobuf service merlion.gauge.v1.Query
 */
export const Query = new ServiceType("merlion.gauge.v1.Query", [
    { name: "Params", options: { "google.api.http": { get: "/merlionzone/merlion/gauge/params" } }, I: QueryParamsRequest, O: QueryParamsResponse }
]);
