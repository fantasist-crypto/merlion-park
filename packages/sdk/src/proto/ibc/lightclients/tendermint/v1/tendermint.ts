 ...
 *
 * @generated from protobuf messages ibc.lightclients.tendermint.v1.ClientState
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.tendermint.v1.ConsensusState
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.tendermint.v1.Misbehaviour
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.tendermint.v1.Header
 */
...
/**
 * Fraction defines the protobuf messages type for tmmath.Fraction that only
 * supports positive values.
 *
 * @generated from protobuf messages ibc.lightclients.tendermint.v1.Fraction
 */
...
class ClientState$Type extends MessageType<ClientState> {
    ...
    super(
      ...
      [
        ...
        },
        {
          ...
          T: () => ProofSpec,
          options: { 'gogoproto.moretags': 'yaml:"proof_specs"' },
        },
        {
          no: 9,
          name: 'upgrade_path',
          ...
          options: { 'gogoproto.moretags': 'yaml:"upgrade_path"' },
        },
        {
          no: 10,
          ...
          kind: 'scalar',
          T: 8 /*ScalarType.BOOL*/,
          options: { 'gogoproto.moretags': 'yaml:"allow_update_after_expiry"' },
        },
        {
          no: 11,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ibc.lightclients.tendermint.v1.Fraction trust_level */ 2:
          message.trustLevel = Fraction.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.trustLevel,
        ...
        case /* google.protobuf.Duration trusting_period */ 3:
          message.trustingPeriod = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* google.protobuf.Duration unbonding_period */ 4:
          message.unbondingPeriod = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* google.protobuf.Duration max_clock_drift */ 5:
          message.maxClockDrift = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* ibc.core.client.v1.Height frozen_height */ 6:
          message.frozenHeight = Height.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* ibc.core.client.v1.Height latest_height */ 7:
          message.latestHeight = Height.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* repeated ics23.ProofSpec proof_specs */ 8:
          message.proofSpecs.push(
            ProofSpec.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.proofSpecs.length; i++)
      ProofSpec.internalBinaryWrite(
        message.proofSpecs[i],
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.tendermint.v1.ClientState
 */
...
class ConsensusState$Type extends MessageType<ConsensusState> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ibc.core.commitment.v1.MerkleRoot root */ 2:
          message.root = MerkleRoot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.root,
  ...
  internalBinaryWrite(
    ...
    if (message.root)
      MerkleRoot.internalBinaryWrite(
        message.root,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.tendermint.v1.ConsensusState
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ibc.lightclients.tendermint.v1.Header header_1 */ 2:
          message.header1 = Header.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.header1,
        ...
        case /* ibc.lightclients.tendermint.v1.Header header_2 */ 3:
          message.header2 = Header.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.header2,
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.tendermint.v1.Misbehaviour
 */
...
class Header$Type extends MessageType<Header> {
  constructor() {
    super('ibc.lightclients.tendermint.v1.Header', [
      ...
      },
      {
        ...
        kind: 'message',
        T: () => ValidatorSet,
        options: { 'gogoproto.moretags': 'yaml:"validator_set"' },
      },
      {
        no: 3,
        name: 'trusted_height',
      ...
      },
      {
        ...
        kind: 'message',
        T: () => ValidatorSet,
        options: { 'gogoproto.moretags': 'yaml:"trusted_validators"' },
      },
    ])
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* tendermint.types.SignedHeader signed_header */ 1:
          message.signedHeader = SignedHeader.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* tendermint.types.ValidatorSet validator_set */ 2:
          message.validatorSet = ValidatorSet.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* ibc.core.client.v1.Height trusted_height */ 3:
          message.trustedHeight = Height.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* tendermint.types.ValidatorSet trusted_validators */ 4:
          message.trustedValidators = ValidatorSet.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.signedHeader)
      SignedHeader.internalBinaryWrite(
        message.signedHeader,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.tendermint.v1.Header
 */
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.tendermint.v1.Fraction
 */
