 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.ClientState
 */
 ...
 * consensus state.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.ConsensusState
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.Header
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.Misbehaviour
 */
 ...
 * signature.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.SignatureAndData
 */
 ...
 * signature.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.TimestampedSignatureData
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.SignBytes
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.HeaderData
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.ClientStateData
 */
 ...
 * verification.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.ConsensusStateData
 */
 ...
 * verification.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.ConnectionStateData
 */
 ...
 * verification.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.ChannelStateData
 */
 ...
 * verification.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.PacketCommitmentData
 */
 ...
 * verification.
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.PacketAcknowledgementData
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.PacketReceiptAbsenceData
 */
 ...
 *
 * @generated from protobuf messages ibc.lightclients.solomachine.v2.NextSequenceRecvData
 */
...
class ClientState$Type extends MessageType<ClientState> {
    ...
    super(
      ...
      [
        { no: 1, name: 'sequence', kind: 'scalar', T: 4 /*ScalarType.UINT64*/ },
        {
          ...
          kind: 'scalar',
          T: 8 /*ScalarType.BOOL*/,
          options: { 'gogoproto.moretags': 'yaml:"is_frozen"' },
        },
        {
          no: 3,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* uint64 sequence */ 1:
          ...
          break
        case /* bool is_frozen */ 2:
          message.isFrozen = reader.bool()
          break
        case /* ibc.lightclients.solomachine.v2.ConsensusState consensus_state */ 3:
          message.consensusState = ConsensusState.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.isFrozen !== false)
      writer.tag(2, WireType.Varint).bool(message.isFrozen)
    /* ibc.lightclients.solomachine.v2.ConsensusState consensus_state = 3; */
    if (message.consensusState)
      ConsensusState.internalBinaryWrite(
        message.consensusState,
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.ClientState
 */
      ...
      [
        {
          ...
          kind: 'message',
          T: () => Any,
          options: { 'gogoproto.moretags': 'yaml:"public_key"' },
        },
        {
          no: 2,
          name: 'diversifier',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.Any public_key */ 1:
          message.publicKey = Any.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.publicKey,
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.ConsensusState
 */
    ...
    super(
      ...
      [
        ...
        },
        {
          ...
          kind: 'message',
          T: () => Any,
          options: { 'gogoproto.moretags': 'yaml:"new_public_key"' },
        },
        {
          no: 5,
          ...
          kind: 'scalar',
          T: 9 /*ScalarType.STRING*/,
          options: { 'gogoproto.moretags': 'yaml:"new_diversifier"' },
        },
      ],
      { 'gogoproto.goproto_getters': false },
    )
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Any new_public_key */ 4:
          message.newPublicKey = Any.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.Header
 */
...
class Misbehaviour$Type extends MessageType<Misbehaviour> {
    ...
    super(
      ...
      [
        ...
        { no: 2, name: 'sequence', kind: 'scalar', T: 4 /*ScalarType.UINT64*/ },
        {
          ...
          kind: 'message',
          T: () => SignatureAndData,
          options: { 'gogoproto.moretags': 'yaml:"signature_one"' },
        },
        {
          no: 4,
          name: 'signature_two',
          kind: 'message',
          T: () => SignatureAndData,
          options: { 'gogoproto.moretags': 'yaml:"signature_two"' },
        },
      ],
      { 'gogoproto.goproto_getters': false },
    )
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* uint64 sequence */ 2:
          message.sequence = reader.uint64().toString()
          break
        case /* ibc.lightclients.solomachine.v2.SignatureAndData signature_one */ 3:
          message.signatureOne = SignatureAndData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
          ...
          break
        case /* ibc.lightclients.solomachine.v2.SignatureAndData signature_two */ 4:
          message.signatureTwo = SignatureAndData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    /* ibc.lightclients.solomachine.v2.SignatureAndData signature_one = 3; */
    if (message.signatureOne)
      SignatureAndData.internalBinaryWrite(
        message.signatureOne,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join()
    /* ibc.lightclients.solomachine.v2.SignatureAndData signature_two = 4; */
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.Misbehaviour
 */
...
class SignatureAndData$Type extends MessageType<SignatureAndData> {
    ...
    super(
      ...
      [
        ...
        },
        {
          ...
          options: { 'gogoproto.moretags': 'yaml:"data_type"' },
        },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* bytes signature */ 1:
          message.signature = reader.bytes()
          break
        case /* ibc.lightclients.solomachine.v2.DataType data_type */ 2:
  ...
  internalBinaryWrite(
    ...
    /* ibc.lightclients.solomachine.v2.DataType data_type = 2; */
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.SignatureAndData
 */
...
class TimestampedSignatureData$Type extends MessageType<TimestampedSignatureData> {
      ...
      [
        {
          ...
          kind: 'scalar',
          T: 12 /*ScalarType.BYTES*/,
          options: { 'gogoproto.moretags': 'yaml:"signature_data"' },
        },
        {
          no: 2,
          name: 'timestamp',
  ...
  create(
    value?: PartialMessage<TimestampedSignatureData>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: TimestampedSignatureData,
  ): TimestampedSignatureData {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.TimestampedSignatureData
 */
...
class SignBytes$Type extends MessageType<SignBytes> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* string diversifier */ 3:
          message.diversifier = reader.string()
          break
        case /* ibc.lightclients.solomachine.v2.DataType data_type */ 4:
          message.dataType = reader.int32()
          break
        case /* bytes data */ 5:
          message.data = reader.bytes()
  ...
  internalBinaryWrite(
    ...
    /* ibc.lightclients.solomachine.v2.DataType data_type = 4; */
    if (message.dataType !== 0)
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.SignBytes
 */
      ...
      [
        {
          ...
          kind: 'message',
          T: () => Any,
          options: { 'gogoproto.moretags': 'yaml:"new_pub_key"' },
        },
        {
          no: 2,
          name: 'new_diversifier',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.Any new_pub_key */ 1:
          message.newPubKey = Any.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.newPubKey,
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.HeaderData
 */
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.ClientStateData
 */
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.ConsensusStateData
 */
...
class ConnectionStateData$Type extends MessageType<ConnectionStateData> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ibc.core.connection.v1.ConnectionEnd connection */ 2:
          message.connection = ConnectionEnd.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.connection,
  ...
  internalBinaryWrite(
    ...
    if (message.connection)
      ConnectionEnd.internalBinaryWrite(
        message.connection,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.ConnectionStateData
 */
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.ChannelStateData
 */
...
class PacketCommitmentData$Type extends MessageType<PacketCommitmentData> {
  constructor() {
    super('ibc.lightclients.solomachine.v2.PacketCommitmentData', [
      { no: 1, name: 'path', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.PacketCommitmentData
 */
...
class PacketAcknowledgementData$Type extends MessageType<PacketAcknowledgementData> {
  constructor() {
    super('ibc.lightclients.solomachine.v2.PacketAcknowledgementData', [
      { no: 1, name: 'path', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
      {
        no: 2,
  ...
  create(
    value?: PartialMessage<PacketAcknowledgementData>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: PacketAcknowledgementData,
  ): PacketAcknowledgementData {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.PacketAcknowledgementData
 */
...
class PacketReceiptAbsenceData$Type extends MessageType<PacketReceiptAbsenceData> {
  constructor() {
    super('ibc.lightclients.solomachine.v2.PacketReceiptAbsenceData', [
      { no: 1, name: 'path', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
    ])
  }
  create(
    value?: PartialMessage<PacketReceiptAbsenceData>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: PacketReceiptAbsenceData,
  ): PacketReceiptAbsenceData {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.PacketReceiptAbsenceData
 */
...
class NextSequenceRecvData$Type extends MessageType<NextSequenceRecvData> {
  constructor() {
    super('ibc.lightclients.solomachine.v2.NextSequenceRecvData', [
      { no: 1, name: 'path', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
      {
        no: 2,
        name: 'next_seq_recv',
        kind: 'scalar',
        T: 4 /*ScalarType.UINT64*/,
        options: { 'gogoproto.moretags': 'yaml:"next_seq_recv"' },
      },
    ])
  }
...
/**
 * @generated MessageType for protobuf messages ibc.lightclients.solomachine.v2.NextSequenceRecvData
 */
