...
class ClientState$Type extends MessageType<ClientState> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.ClientState", [
            { no: 1, name: "sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 2, name: "is_frozen", kind: "scalar", T: 8 /*ScalarType.BOOL*/, options: { "gogoproto.moretags": "yaml:\"is_frozen\"" } },
    ...
    create(value?: PartialMessage<ClientState>): ClientState {
        const message = { sequence: "0", isFrozen: false, allowUpdateAfterProposal: false };
...
class ConsensusState$Type extends MessageType<ConsensusState> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.ConsensusState", [
...
class Header$Type extends MessageType<Header> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.Header", [
            { no: 1, name: "sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
...
class Misbehaviour$Type extends MessageType<Misbehaviour> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.Misbehaviour", [
...
class SignatureAndData$Type extends MessageType<SignatureAndData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.SignatureAndData", [
            { no: 1, name: "signature", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "data_type", kind: "enum", T: () => ["ibc.lightclients.solomachine.v2.DataType", DataType, "DATA_TYPE_"], options: { "gogoproto.moretags": "yaml:\"data_type\"" } },
...
class TimestampedSignatureData$Type extends MessageType<TimestampedSignatureData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.TimestampedSignatureData", [
...
class SignBytes$Type extends MessageType<SignBytes> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.SignBytes", [
            { no: 1, name: "sequence", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 2, name: "timestamp", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 3, name: "diversifier", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "data_type", kind: "enum", T: () => ["ibc.lightclients.solomachine.v2.DataType", DataType, "DATA_TYPE_"], options: { "gogoproto.moretags": "yaml:\"data_type\"" } },
...
class HeaderData$Type extends MessageType<HeaderData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.HeaderData", [
...
class ClientStateData$Type extends MessageType<ClientStateData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.ClientStateData", [
...
class ConsensusStateData$Type extends MessageType<ConsensusStateData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.ConsensusStateData", [
            { no: 1, name: "path", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
...
class ConnectionStateData$Type extends MessageType<ConnectionStateData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.ConnectionStateData", [
            { no: 1, name: "path", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
...
class ChannelStateData$Type extends MessageType<ChannelStateData> {
    constructor() {
        super("ibc.lightclients.solomachine.v2.ChannelStateData", [
            { no: 1, name: "path", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
