 ...
 *
 * @generated from protobuf messages ibc.core.commitment.v1.MerkleRoot
 */
 ...
 *
 * @generated from protobuf messages ibc.core.commitment.v1.MerklePrefix
 */
 ...
 *
 * @generated from protobuf messages ibc.core.commitment.v1.MerklePath
 */
 ...
 *
 * @generated from protobuf messages ibc.core.commitment.v1.MerkleProof
 */
...
/**
 * @generated MessageType for protobuf messages ibc.core.commitment.v1.MerkleRoot
 */
    ...
    super('ibc.core.commitment.v1.MerklePrefix', [
      {
        ...
        options: { 'gogoproto.moretags': 'yaml:"key_prefix"' },
      },
    ])
  }
...
/**
 * @generated MessageType for protobuf messages ibc.core.commitment.v1.MerklePrefix
 */
      ...
      [
        {
          ...
          options: { 'gogoproto.moretags': 'yaml:"key_path"' },
        },
      ],
...
/**
 * @generated MessageType for protobuf messages ibc.core.commitment.v1.MerklePath
 */
...
class MerkleProof$Type extends MessageType<MerkleProof> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated ics23.CommitmentProof proofs */ 1:
          message.proofs.push(
            CommitmentProof.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.proofs.length; i++)
      CommitmentProof.internalBinaryWrite(
        message.proofs[i],
...
/**
 * @generated MessageType for protobuf messages ibc.core.commitment.v1.MerkleProof
 */
