 ...
 *
 * @generated from protobuf messages ibc.core.client.v1.GenesisState
 */
 ...
 * with ExportMetadata
 *
 * @generated from protobuf messages ibc.core.client.v1.GenesisMetadata
 */
 ...
 * client id.
 *
 * @generated from protobuf messages ibc.core.client.v1.IdentifiedGenesisMetadata
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
  constructor() {
    super('ibc.core.client.v1.GenesisState', [
      ...
      },
      {
        ...
        kind: 'scalar',
        T: 8 /*ScalarType.BOOL*/,
        options: { 'gogoproto.moretags': 'yaml:"create_localhost"' },
      },
      {
        no: 6,
        ...
        options: { 'gogoproto.moretags': 'yaml:"next_client_sequence"' },
      },
    ])
  }
      ...
      switch (fieldNo) {
        ...
        case /* repeated ibc.core.client.v1.ClientConsensusStates clients_consensus */ 2:
          message.clientsConsensus.push(
            ClientConsensusStates.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* repeated ibc.core.client.v1.IdentifiedGenesisMetadata clients_metadata */ 3:
          message.clientsMetadata.push(
            IdentifiedGenesisMetadata.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.clientsConsensus.length; i++)
      ClientConsensusStates.internalBinaryWrite(
        message.clientsConsensus[i],
    ...
    for (let i = 0; i < message.clientsMetadata.length; i++)
      IdentifiedGenesisMetadata.internalBinaryWrite(
        message.clientsMetadata[i],
...
/**
 * @generated MessageType for protobuf messages ibc.core.client.v1.GenesisState
 */
...
/**
 * @generated MessageType for protobuf messages ibc.core.client.v1.GenesisMetadata
 */
...
class IdentifiedGenesisMetadata$Type extends MessageType<IdentifiedGenesisMetadata> {
  ...
  create(
    value?: PartialMessage<IdentifiedGenesisMetadata>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: IdentifiedGenesisMetadata,
  ): IdentifiedGenesisMetadata {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated ibc.core.client.v1.GenesisMetadata client_metadata */ 2:
          message.clientMetadata.push(
            GenesisMetadata.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.clientMetadata.length; i++)
      GenesisMetadata.internalBinaryWrite(
        message.clientMetadata[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join()
    let u = options.writeUnknownFields
...
/**
 * @generated MessageType for protobuf messages ibc.core.client.v1.IdentifiedGenesisMetadata
 */
