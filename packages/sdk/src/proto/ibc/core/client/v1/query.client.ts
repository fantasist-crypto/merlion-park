...
export interface IQueryClient {
  ...
  clientState(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryClientStateRequest, QueryClientStateResponse>
  /**
  ...
  clientStates(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryClientStatesRequest, QueryClientStatesResponse>
  /**
  ...
  consensusState(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryConsensusStateRequest, QueryConsensusStateResponse>
  /**
  ...
  consensusStates(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryConsensusStatesRequest, QueryConsensusStatesResponse>
  /**
  ...
  clientStatus(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryClientStatusRequest, QueryClientStatusResponse>
  /**
  ...
  clientParams(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryClientParamsRequest, QueryClientParamsResponse>
  /**
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  clientState(
    ...
    return stackIntercept<QueryClientStateRequest, QueryClientStateResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  clientStates(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryClientStatesRequest, QueryClientStatesResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  clientStatus(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryClientStatusRequest, QueryClientStatusResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  clientParams(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryClientParamsRequest, QueryClientParamsResponse>(
      'unary',
      this._transport,
      method,
      opt,
