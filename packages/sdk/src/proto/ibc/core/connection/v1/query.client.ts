...
export interface IQueryClient {
  ...
  connection(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryConnectionRequest, QueryConnectionResponse>
  /**
  ...
  connections(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryConnectionsRequest, QueryConnectionsResponse>
  /**
  ...
  clientConnections(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryClientConnectionsRequest, QueryClientConnectionsResponse>
  /**
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  connection(
    ...
    return stackIntercept<QueryConnectionRequest, QueryConnectionResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  connections(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryConnectionsRequest, QueryConnectionsResponse>(
      'unary',
      this._transport,
      method,
      opt,
