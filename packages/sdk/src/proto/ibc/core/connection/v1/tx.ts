 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenInit
 */
 ...
 * type.
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenInitResponse
 */
 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenTry
 */
export interface MsgConnectionOpenTry {
  ...
  /**
   * proof of client state included in messages
   *
 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenTryResponse
 */
 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenAck
 */
 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenAckResponse
 */
 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenConfirm
 */
 ...
 * response type.
 *
 * @generated from protobuf messages ibc.core.connection.v1.MsgConnectionOpenConfirmResponse
 */
...
class MsgConnectionOpenInit$Type extends MessageType<MsgConnectionOpenInit> {
    ...
    super(
      ...
      [
        ...
        { no: 3, name: 'version', kind: 'message', T: () => Version },
        {
          ...
          options: { 'gogoproto.moretags': 'yaml:"delay_period"' },
        },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ibc.core.connection.v1.Counterparty counterparty */ 2:
          message.counterparty = Counterparty.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* ibc.core.connection.v1.Version version */ 3:
          message.version = Version.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.version,
  ...
  internalBinaryWrite(
    ...
    if (message.counterparty)
      Counterparty.internalBinaryWrite(
        message.counterparty,
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenInit
 */
...
class MsgConnectionOpenInitResponse$Type extends MessageType<MsgConnectionOpenInitResponse> {
  ...
  create(
    value?: PartialMessage<MsgConnectionOpenInitResponse>,
    ...
    if (value !== undefined)
      reflectionMergePartial<MsgConnectionOpenInitResponse>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MsgConnectionOpenInitResponse,
  ): MsgConnectionOpenInitResponse {
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenInitResponse
 */
export const MsgConnectionOpenInitResponse =
  new MsgConnectionOpenInitResponse$Type()
// @generated messages type with reflection information, may provide speed optimized methods
    ...
    super(
      ...
      [
        ...
        },
        {
          ...
          kind: 'scalar',
          T: 9 /*ScalarType.STRING*/,
          options: { 'gogoproto.moretags': 'yaml:"previous_connection_id"' },
        },
        {
          no: 3,
          name: 'client_state',
        ...
        },
        {
          ...
          T: () => Version,
          options: { 'gogoproto.moretags': 'yaml:"counterparty_versions"' },
        },
        {
          no: 7,
          name: 'proof_height',
        ...
        },
        {
          ...
          kind: 'scalar',
          T: 12 /*ScalarType.BYTES*/,
          options: { 'gogoproto.moretags': 'yaml:"proof_client"' },
        },
        {
          no: 10,
          ...
          kind: 'scalar',
          T: 12 /*ScalarType.BYTES*/,
          options: { 'gogoproto.moretags': 'yaml:"proof_consensus"' },
        },
        {
          no: 11,
      ...
      switch (fieldNo) {
        ...
        case /* repeated ibc.core.connection.v1.Version counterparty_versions */ 6:
          message.counterpartyVersions.push(
            Version.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
        ...
        case /* ibc.core.client.v1.Height consensus_height */ 11:
          message.consensusHeight = Height.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.previousConnectionId !== '')
      writer
        ...
        .string(message.previousConnectionId)
    ...
    for (let i = 0; i < message.counterpartyVersions.length; i++)
      Version.internalBinaryWrite(
        message.counterpartyVersions[i],
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenTry
 */
...
class MsgConnectionOpenTryResponse$Type extends MessageType<MsgConnectionOpenTryResponse> {
  ...
  create(
    value?: PartialMessage<MsgConnectionOpenTryResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MsgConnectionOpenTryResponse,
  ): MsgConnectionOpenTryResponse {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenTryResponse
 */
export const MsgConnectionOpenTryResponse =
  new MsgConnectionOpenTryResponse$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class MsgConnectionOpenAck$Type extends MessageType<MsgConnectionOpenAck> {
  ...
  internalBinaryWrite(
    ...
    if (message.counterpartyConnectionId !== '')
      writer
        .tag(2, WireType.LengthDelimited)
        .string(message.counterpartyConnectionId)
    /* ibc.core.connection.v1.Version version = 3; */
    if (message.version)
      Version.internalBinaryWrite(
        message.version,
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenAck
 */
...
class MsgConnectionOpenAckResponse$Type extends MessageType<MsgConnectionOpenAckResponse> {
  ...
  create(
    value?: PartialMessage<MsgConnectionOpenAckResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MsgConnectionOpenAckResponse,
  ): MsgConnectionOpenAckResponse {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenAckResponse
 */
export const MsgConnectionOpenAckResponse =
  new MsgConnectionOpenAckResponse$Type()
// @generated messages type with reflection information, may provide speed optimized methods
class MsgConnectionOpenConfirm$Type extends MessageType<MsgConnectionOpenConfirm> {
  ...
  create(
    value?: PartialMessage<MsgConnectionOpenConfirm>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MsgConnectionOpenConfirm,
  ): MsgConnectionOpenConfirm {
    let message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenConfirm
 */
...
class MsgConnectionOpenConfirmResponse$Type extends MessageType<MsgConnectionOpenConfirmResponse> {
  ...
  create(
    value?: PartialMessage<MsgConnectionOpenConfirmResponse>,
    ...
    if (value !== undefined)
      reflectionMergePartial<MsgConnectionOpenConfirmResponse>(
        this,
        message,
        value,
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MsgConnectionOpenConfirmResponse,
  ): MsgConnectionOpenConfirmResponse {
    return target ?? this.create()
  }
  internalBinaryWrite(
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.MsgConnectionOpenConfirmResponse
 */
export const MsgConnectionOpenConfirmResponse =
  new MsgConnectionOpenConfirmResponse$Type()
/**
