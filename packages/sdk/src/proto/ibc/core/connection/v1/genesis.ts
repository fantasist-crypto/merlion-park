 ...
 *
 * @generated from protobuf messages ibc.core.connection.v1.GenesisState
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
  constructor() {
    super('ibc.core.connection.v1.GenesisState', [
      ...
      },
      {
        ...
        options: { 'gogoproto.moretags': 'yaml:"next_connection_sequence"' },
      },
      {
        no: 4,
        name: 'params',
      ...
      switch (fieldNo) {
        ...
        case /* repeated ibc.core.connection.v1.ConnectionPaths client_connection_paths */ 2:
          message.clientConnectionPaths.push(
            ConnectionPaths.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.clientConnectionPaths.length; i++)
      ConnectionPaths.internalBinaryWrite(
        message.clientConnectionPaths[i],
...
/**
 * @generated MessageType for protobuf messages ibc.core.connection.v1.GenesisState
 */
