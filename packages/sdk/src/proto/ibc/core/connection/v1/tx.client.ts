...
export interface IMsgClient {
  ...
  connectionOpenInit(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgConnectionOpenInit, MsgConnectionOpenInitResponse>
  /**
  ...
  connectionOpenTry(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgConnectionOpenTry, MsgConnectionOpenTryResponse>
  /**
  ...
  connectionOpenAck(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgConnectionOpenAck, MsgConnectionOpenAckResponse>
  /**
  ...
  connectionOpenConfirm(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgConnectionOpenConfirm, MsgConnectionOpenConfirmResponse>
}
/**
 * Msg defines the ibc/connection Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  connectionOpenInit(
    ...
    return stackIntercept<MsgConnectionOpenInit, MsgConnectionOpenInitResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  connectionOpenTry(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgConnectionOpenTry, MsgConnectionOpenTryResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  connectionOpenAck(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgConnectionOpenAck, MsgConnectionOpenAckResponse>(
      'unary',
      this._transport,
      method,
      opt,
