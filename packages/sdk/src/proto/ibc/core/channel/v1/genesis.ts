 ...
 *
 * @generated from protobuf messages ibc.core.channel.v1.GenesisState
 */
 ...
 *
 * @generated from protobuf messages ibc.core.channel.v1.PacketSequence
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
  constructor() {
    super('ibc.core.channel.v1.GenesisState', [
      ...
      },
      {
        ...
        options: { 'gogoproto.moretags': 'yaml:"next_channel_sequence"' },
      },
    ])
  }
      ...
      switch (fieldNo) {
        ...
        case /* repeated ibc.core.channel.v1.PacketSequence send_sequences */ 5:
          message.sendSequences.push(
            PacketSequence.internalBinaryRead(reader, reader.uint32(), options),
          )
          break
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.sendSequences.length; i++)
      PacketSequence.internalBinaryWrite(
        message.sendSequences[i],
...
/**
 * @generated MessageType for protobuf messages ibc.core.channel.v1.GenesisState
 */
...
/**
 * @generated MessageType for protobuf messages ibc.core.channel.v1.PacketSequence
 */
