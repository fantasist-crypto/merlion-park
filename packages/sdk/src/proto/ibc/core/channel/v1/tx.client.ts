...
export interface IMsgClient {
  ...
  channelOpenInit(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgChannelOpenInit, MsgChannelOpenInitResponse>
  /**
  ...
  channelOpenTry(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgChannelOpenTry, MsgChannelOpenTryResponse>
  /**
  ...
  channelOpenAck(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgChannelOpenAck, MsgChannelOpenAckResponse>
  /**
  ...
  channelOpenConfirm(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgChannelOpenConfirm, MsgChannelOpenConfirmResponse>
  /**
  ...
  channelCloseInit(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgChannelCloseInit, MsgChannelCloseInitResponse>
  /**
  ...
  channelCloseConfirm(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgChannelCloseConfirm, MsgChannelCloseConfirmResponse>
  /**
  ...
  recvPacket(
    input: MsgRecvPacket,
    options?: RpcOptions,
  ): UnaryCall<MsgRecvPacket, MsgRecvPacketResponse>
  /**
  ...
  timeout(
    input: MsgTimeout,
    options?: RpcOptions,
  ): UnaryCall<MsgTimeout, MsgTimeoutResponse>
  /**
  ...
  timeoutOnClose(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgTimeoutOnClose, MsgTimeoutOnCloseResponse>
  /**
  ...
  acknowledgement(
    ...
    options?: RpcOptions,
  ): UnaryCall<MsgAcknowledgement, MsgAcknowledgementResponse>
}
/**
 * Msg defines the ibc/channel Msg service.
 *
...
export class MsgClient implements IMsgClient, ServiceInfo {
  ...
  channelOpenInit(
    ...
    return stackIntercept<MsgChannelOpenInit, MsgChannelOpenInitResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  channelOpenTry(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgChannelOpenTry, MsgChannelOpenTryResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  channelOpenAck(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgChannelOpenAck, MsgChannelOpenAckResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  channelOpenConfirm(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgChannelOpenConfirm, MsgChannelOpenConfirmResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  channelCloseInit(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgChannelCloseInit, MsgChannelCloseInitResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  recvPacket(
    ...
    const method = this.methods[6],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgRecvPacket, MsgRecvPacketResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  timeout(
    ...
    const method = this.methods[7],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgTimeout, MsgTimeoutResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  timeoutOnClose(
    ...
    const method = this.methods[8],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgTimeoutOnClose, MsgTimeoutOnCloseResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  acknowledgement(
    ...
    const method = this.methods[9],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<MsgAcknowledgement, MsgAcknowledgementResponse>(
      'unary',
      this._transport,
      method,
      opt,
