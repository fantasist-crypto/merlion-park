 ...
 *
 * @generated from protobuf messages ibc.core.types.v1.GenesisState
 */
...
class GenesisState$Type extends MessageType<GenesisState> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* ibc.core.client.v1.GenesisState client_genesis */ 1:
          message.clientGenesis = GenesisState$.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* ibc.core.connection.v1.GenesisState connection_genesis */ 2:
          message.connectionGenesis = GenesisState$2.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* ibc.core.channel.v1.GenesisState channel_genesis */ 3:
          message.channelGenesis = GenesisState$3.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.clientGenesis)
      GenesisState$.internalBinaryWrite(
        message.clientGenesis,
    ...
    if (message.connectionGenesis)
      GenesisState$2.internalBinaryWrite(
        message.connectionGenesis,
    ...
    if (message.channelGenesis)
      GenesisState$3.internalBinaryWrite(
        message.channelGenesis,
...
/**
 * @generated MessageType for protobuf messages ibc.core.types.v1.GenesisState
 */
