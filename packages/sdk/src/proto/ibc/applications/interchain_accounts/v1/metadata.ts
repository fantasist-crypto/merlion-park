 ...
 *
 * @generated from protobuf messages ibc.applications.interchain_accounts.v1.Metadata
 */
  ...
  constructor() {
    super('ibc.applications.interchain_accounts.v1.Metadata', [
      { no: 1, name: 'version', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        options: { 'gogoproto.moretags': 'yaml:"controller_connection_id"' },
      },
      {
        no: 3,
        ...
        kind: 'scalar',
        T: 9 /*ScalarType.STRING*/,
        options: { 'gogoproto.moretags': 'yaml:"host_connection_id"' },
      },
  ...
  internalBinaryWrite(
    ...
    if (message.controllerConnectionId !== '')
      writer
        ...
        .string(message.controllerConnectionId)
...
/**
 * @generated MessageType for protobuf messages ibc.applications.interchain_accounts.v1.Metadata
 */
