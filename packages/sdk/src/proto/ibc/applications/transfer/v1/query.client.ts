...
export interface IQueryClient {
   ...
   */
  denomTrace(
    input: QueryDenomTraceRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryDenomTraceRequest, QueryDenomTraceResponse>
  /**
   ...
   */
  denomTraces(
    input: QueryDenomTracesRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryDenomTracesRequest, QueryDenomTracesResponse>
  /**
  ...
  denomHash(
    ...
    options?: RpcOptions,
  ): UnaryCall<QueryDenomHashRequest, QueryDenomHashResponse>
}
/**
 * Query provides defines the gRPC querier service.
 *
...
export class QueryClient implements IQueryClient, ServiceInfo {
  ...
  denomTrace(
    ...
    return stackIntercept<QueryDenomTraceRequest, QueryDenomTraceResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  denomTraces(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryDenomTracesRequest, QueryDenomTracesResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  denomHash(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<QueryDenomHashRequest, QueryDenomHashResponse>(
      'unary',
      this._transport,
      method,
      opt,
