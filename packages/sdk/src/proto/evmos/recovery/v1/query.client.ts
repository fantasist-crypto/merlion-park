 ...
 *
 * @generated from protobuf service evmos.recovery.v1.Query
 */
export interface IQueryClient {
  /**
   * Params retrieves the total set of recovery parameters.
   *
   * @generated from protobuf rpc: Params(evmos.recovery.v1.QueryParamsRequest) returns (evmos.recovery.v1.QueryParamsResponse);
   */
  params(
