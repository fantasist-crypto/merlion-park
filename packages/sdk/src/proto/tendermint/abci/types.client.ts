...
export interface IABCIApplicationClient {
  ...
  echo(
    input: RequestEcho,
    options?: RpcOptions,
  ): UnaryCall<RequestEcho, ResponseEcho>
  /**
  ...
  flush(
    input: RequestFlush,
    options?: RpcOptions,
  ): UnaryCall<RequestFlush, ResponseFlush>
  /**
  ...
  checkTx(
    ...
    options?: RpcOptions,
  ): UnaryCall<RequestCheckTx, ResponseCheckTx>
  /**
  ...
  query(
    input: RequestQuery,
    options?: RpcOptions,
  ): UnaryCall<RequestQuery, ResponseQuery>
  /**
  ...
  commit(
    input: RequestCommit,
    options?: RpcOptions,
  ): UnaryCall<RequestCommit, ResponseCommit>
  /**
  ...
  listSnapshots(
    ...
    options?: RpcOptions,
  ): UnaryCall<RequestListSnapshots, ResponseListSnapshots>
  /**
  ...
  offerSnapshot(
    ...
    options?: RpcOptions,
  ): UnaryCall<RequestOfferSnapshot, ResponseOfferSnapshot>
  /**
  ...
  loadSnapshotChunk(
    ...
    options?: RpcOptions,
  ): UnaryCall<RequestLoadSnapshotChunk, ResponseLoadSnapshotChunk>
  /**
  ...
  applySnapshotChunk(
    ...
    options?: RpcOptions,
  ): UnaryCall<RequestApplySnapshotChunk, ResponseApplySnapshotChunk>
}
// ----------------------------------------
// Service Definition
...
export class ABCIApplicationClient
  implements IABCIApplicationClient, ServiceInfo
{
  ...
  echo(
    ...
    return stackIntercept<RequestEcho, ResponseEcho>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  flush(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestFlush, ResponseFlush>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  info(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestInfo, ResponseInfo>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  setOption(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestSetOption, ResponseSetOption>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  deliverTx(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestDeliverTx, ResponseDeliverTx>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  checkTx(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestCheckTx, ResponseCheckTx>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  query(
    ...
    const method = this.methods[6],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestQuery, ResponseQuery>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  commit(
    ...
    const method = this.methods[7],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestCommit, ResponseCommit>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  initChain(
    ...
    const method = this.methods[8],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestInitChain, ResponseInitChain>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  beginBlock(
    ...
    const method = this.methods[9],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestBeginBlock, ResponseBeginBlock>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  endBlock(
    ...
    const method = this.methods[10],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestEndBlock, ResponseEndBlock>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  listSnapshots(
    ...
    const method = this.methods[11],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestListSnapshots, ResponseListSnapshots>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  offerSnapshot(
    ...
    const method = this.methods[12],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestOfferSnapshot, ResponseOfferSnapshot>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  loadSnapshotChunk(
    ...
    const method = this.methods[13],
      opt = this._transport.mergeOptions(options)
    return stackIntercept<RequestLoadSnapshotChunk, ResponseLoadSnapshotChunk>(
      'unary',
      this._transport,
      method,
      opt,
